...
return new class extends Migration
{
    ...
    {
        Schema::create('cal_temperature', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('cal_temperature_detail', function (Blueprint $table) {
            $table->id();
            $table->foreignId('temperature_id')->constrained('cal_temperature')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('cal_temperature_detail');
        Schema::dropIfExists('cal_temperature');
    }
};
