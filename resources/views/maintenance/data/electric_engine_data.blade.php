...
<script>
            ...
            return `
                    ...
                    <div class="row g-3 mt-2">
                        <div class="col-md-6">
                            ...
                            <div>${row.electric_engine?.keterangan ?? '-'}</div>
                        </div>
                        <div class="col-md-6">
    ...
    : '<div>-</div>'
        ...
        const dtElectricEngine = $('#tabelElectricEngine').DataTable({
            processing: true,
            serverSide: true,
            searching: false,
            pageLength: 10,
            ...
            columns: [{
                ...
                {
                    data: 'electric_engine.mesin.nama_mesin',
                    orderable: false,
                    defaultContent: '-'
                },
                {
                    data: 'electric_engine.mesin.lokasi',
                    orderable: false,
                    defaultContent: '-'
                },
                {
        ...
        $(document).on('click', '.btn-edit', function() {
            ...
            $('#editKorektif').val(row.electric_engine?.korektif ?? '');
            $('#editNamaMesin')
            ...
            const ketMap = parseKeteranganPairs(row.electric_engine?.keterangan);
        ...
        $('#formEditElectricEngine').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    $('#tabelElectricEngine').DataTable().ajax.reload(null, false);
                },
                error: function(xhr) {
                    Swal.fire({
                        icon: 'error',
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        Swal.fire('Berhasil', res.message ||
                            ...
                            'success');
                        dtElectricEngine.ajax.reload(null,
                            false);
                    },
                    error: function(xhr) {
                        Swal.fire({
