                    ...
                    <div class="detail-meta row g-3 mb-2">
                       <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="meta-value">${row.utility?.mesin?.kode_mesin ?? '-'}</div>
                        </div>
                        <div class="col-md-3">
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        currentRows.forEach((row, index) => {
                            ...
                            const machineName = utility.mesin?.nama_mesin || '-';
                            const machineCode = utility.mesin?.kode_mesin || '-';
                            const location = utility.mesin?.lokasi || '-';
