                ...
                return `
                    <div class="detail-meta row g-3 mb-2">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="meta-value">${row.refrigerasi?.mesin?.kode_mesin ?? '-'}</div>
                        </div>
                        <div class="col-md-3">
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        currentRows.forEach((row, index) => {
                            ...
                            const refrigerasi = row.refrigerasi || {};
                            const machineName = refrigerasi.mesin?.nama_mesin || '-';
                            const machineCode = refrigerasi.mesin?.kode_mesin || '-';
                            const location = refrigerasi.mesin?.lokasi || '-';
