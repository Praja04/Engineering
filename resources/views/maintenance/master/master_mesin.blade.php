                            ...
                            <form id="formMesin" novalidate>
                                ...
                                <div class="modal-body-custom">
                                    ...
                                    <div class="form-group-c">
                                        ...
                                        <input type="text" class="form-control-c" id="nama_mesin" placeholder="Contoh: Kompresor Udara #1" required>
                                    </div>

                                    <div class="form-row">
                                        <div class="form-group-c">
                                            <label class="form-label-c">Lokasi <span class="req">*</span></label>
                                            <input type="text" class="form-control-c" id="lokasi" placeholder="Contoh: Lantai 1" required>
                                        </div>
                                        <div class="form-group-c">
                                            <label class="form-label-c">Departemen</label>
                                            <input type="text" class="form-control-c" id="dept" placeholder="Contoh: Produksi">
                                        </div>
                                    </div>

                                    <div class="form-group-c">
                                        <label class="form-label-c">Kode Mesin</label>
                                        <input type="text" class="form-control-c" id="kode_mesin" placeholder="Contoh: MES-001">
                                    </div>
                                ...
                                <div class="modal-footer-custom">
                                    <button type="button" class="btn-base btn-outline-c" data-bs-dismiss="modal">Batal</button>
                ...
                <div class="modal-content modal-content-custom">
                    ...
                    <div class="modal-body-custom">
                        ...
                        <div id="filePreview" class="file-preview-box mt-3" style="display:none">
                            ...
                            <button type="button" class="btn-base btn-ghost-danger btn-sm-c ms-auto" id="btnClearFile">
                                <i class="mdi mdi-close"></i>
                            </button>
                        </div>
        ...
        function renderTable() {
            ...
            for (let p = 1; p <= totalPages; p++) {
                if (totalPages > 7 && Math.abs(p - page) > 2 && p !== 1 && p !== totalPages) {
                    if (p === 2 || p === totalPages - 1) pHtml += `<span class="page-btn" style="pointer-events:none">…</span>`;
                    continue;
                }
                ...
                if (json.status) {
                    ...
                    if (json.errors && json.errors.length) {
                        ...
                        json.errors.forEach(e => {
                            errHtml += `<li><span class="error-row-num">Baris ${e.baris}</span>${e.masalah}</li>`;
                        });
                        errHtml += `</ul>`;
                    }
