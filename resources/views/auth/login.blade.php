...
<head>
    ...
    <style>
        .auth-one-bg-position {
            background-image: url("{{ asset('assets/signin.jpg') }}");
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    <img src="{{ asset('assets/bas.png') }}" alt="PT.Bumi Alam Segar" style="width: 200px;">
                                </div>
                                <div class="text-center mt-2">

                                    <br>
                                    <h5 class="text-primary">Welcome Back to BAS Engineering System!</h5>
