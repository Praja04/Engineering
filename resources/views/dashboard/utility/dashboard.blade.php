...
<script>
    ...
    $(function() {
        ...
        // Load operator
        fetchTopOperator("{{ url('utility/top5/operator/air') }}", '#top-operator-list');
        fetchTopOperator("{{ url('/api/utility/top5/operator/listrik') }}", '#top-operator-listrik');
        fetchTopOperator("{{ url('utility/top5/operator/chemical') }}", '#top-operator-chemical');
