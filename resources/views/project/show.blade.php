                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('project.fase1.edit', $project) }}" class="btn btn-soft-warning btn-sm">
                                <i class="ri-edit-line me-1"></i> Edit Fase 1
                            </a>

                            <a href="{{ route('project.fase2.create', $project) }}" class="btn btn-soft-primary btn-sm">
                                <i class="ri-arrow-right-line me-1"></i> Lanjut ke Fase 2
                            </a>
                            @endif

                            @if ($project->faseDua && $project->fase_aktif === 'fase_2')
                            <a href="{{ route('project.fase2.edit', $project) }}" class="btn btn-soft-warning btn-sm">
                                <i class="ri-edit-line me-1"></i> Edit Fase 2
                            </a>
                            <a href="{{ route('project.fase3.create', $project) }}" class="btn btn-soft-primary btn-sm">
                                <i class="ri-arrow-right-line me-1"></i> Lanjut ke Fase 3
                            </a>
                            @endif

                            @if ($project->faseTiga && $project->fase_aktif === 'fase_3')
                            <a href="{{ route('project.fase3.edit', $project) }}" class="btn btn-soft-warning btn-sm">
                                        ...
                                        <div class="d-flex flex-wrap gap-2">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <a href="{{ Storage::url($dok->path_file) }}" target="_blank">
                                                    <img src="{{ Storage::url($dok->path_file) }}" alt="{{ $dok->nama_file }}" class="doc-thumb border">
                                                </a>
                                                @else
                                                <a href="{{ Storage::url($dok->path_file) }}" target="_blank" class="btn btn-soft-secondary btn-sm">
                                                    <i class="ri-file-line me-1"></i>
                                                    {{ Str::limit($dok->nama_file, 20) }}
                                                </a>
                                                @endif
                                                <form method="POST" action="{{ route('project.dokumentasi.destroy', $dok) }}" class="d-inline form-hapus-dok">
                                                    @csrf @method('DELETE')
                                                    <button type="submit" class="btn btn-danger btn-xs position-absolute top-0 end-0" title="Hapus">
