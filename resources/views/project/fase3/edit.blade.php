...
@section('title', 'Edit Fase 3 – ' . $project->nomor_moc)
                    ...
                    <div class="card-header">
                        <div class="step-header">
                            ...
                            <div>
                                ...
                                <small class="text-muted">Edit data pekerjaan project <strong>{{ $project->nomor_moc }}</strong></small>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('project.fase3.update', $project) }}"
                              enctype="multipart/form-data" id="formFase3Edit">
                            @csrf @method('PUT')
                            ...
                            <div class="row gy-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="ejo"
                                           ...
                                           value="{{ old('ejo', $faseTiga?->ejo) }}" placeholder="Opsional">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="deskripsi"
                                           ...
                                           value="{{ old('deskripsi', $faseTiga?->deskripsi) }}">
                                    ...
                                    <select name="user_id" id="user_id"
                                        ...
                                        @foreach ($users as $user)
                                            <option value="{{ $user->id }}"
                                                {{ old('user_id', $faseTiga?->user_id) == $user->id ? 'selected' : '' }}>
                                                {{ $user->username }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="keterangan" rows="3"
                                              ...
                                              placeholder="Catatan tambahan (opsional)">{{ old('keterangan', $faseTiga?->keterangan) }}</textarea>
