                                ...
                                <div class="row g-3 mb-0 align-items-center">
                                    ...
                                    <div class="col-sm-auto">
                                        <div class="input-group">
                                            <input style="font-size: 24px; width: 200px; height: 50px;" id="PV-bar"
                                                type="text"
                                                class="text-center form-control border-0 dash-filter-picker shadow "
                                                disabled>
                                    ...
                                    <div class="card-body" style="z-index: 1">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1 overflow-hidden">
                                                ...
                                                <h4 class="fs-22 fw-semibold ff-secondary mb-0">
                                                    <span class="counter-value" id="pvsteam_abnormal"
                                                        data-target=""></span>
                                                </h4>
                                            </div>
                                    ...
                                    <div class="card-body" style="z-index: 1">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1 overflow-hidden">
                                                ...
                                                <h4 class="fs-22 fw-semibold ff-secondary mb-0">
                                                    <span class="counter-value" id="levelfeed_abnormal"
                                                        data-target=""></span>
                                                </h4>
                                            </div>
...
@section('scripts')
    <script>
        $(document).ready(function() {
                            ...
                            value: {
                                ...
                                formatter: function(val) {
                                    return parseFloat(val).toFixed(
                                        2); // misal tampilkan 1 angka desimal
                                }
                            }
                        }
                    }
            ...
            const updatePVSteam = () => {
                $.getJSON("{{ url('boiler/sensor/boiler-realtime') }}", (response) => {
                    if (response) {
            ...
            $("#applyFilter").on("click", () => {
                ...
                if (filter === "latest") {
                    url = "{{ url('boiler/sensor/boiler-data') }}";
                    ...
                    url = "{{ url('boiler/sensor/boiler/data-mingguan') }}";
                    params = {
                        tanggal_mulai: start,
                        tanggal_selesai: end
                    };
            ...
            function fetchData_abnormal(filter = 'today', start = '', end = '') {
                ...
                $.ajax({
                    url: "{{ url('boiler/sensor/levelfeedwater') }}",
                    method: 'GET',
                    data: {
                        filter,
                        start,
            ...
            $('.abnormal-card').on('click', function() {
                ...
                $.ajax({
                    url: "{{ url('boiler/sensor') }}/" + type, // asumsi endpoint sama
                    method: 'GET',
                    data: {
