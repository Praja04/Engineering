    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="card shadow-sm border-0 rounded-3" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="card-body">
                    <form id="formDimensi" method="POST">
                        @csrf
                        ...
                        <div class="card border border-primary border-opacity-50">
                            <div class="card-header bg-light">
                                <strong><i class="mdi mdi-beaker-outline me-2"></i>Data Pengukuran Dimensi</strong>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered align-middle" id="tableDimensi">
                                        <thead class="table-light">
                                            <tr>
                                                <th class="text-center" style="width:120px;">Titik Kalibrasi (mm)</th>
                                                <th class="text-center">Penunjuk Standar (mm)</th>
                                                <th class="text-center">Penunjuk Alat (mm)</th>
...
@section('scripts')
    <script>
        $(document).ready(function() {
            ...
            const STORAGE_KEY = 'draft_dimensi';
            ...
            $(document).on('input change', '#formDimensi input, #formDimensi select, #formDimensi textarea',
                function() {
                    saveDraft();
                });
            ...
            $('#formDimensi').on('submit', function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    url: "{{ route('kalibrasi.dimensi.store') }}",
                    type: "POST",
                    data: formData,
                    success: function(res) {
                        ...
                        Swal.fire({
                            ...
                            title: 'Berhasil!',
                            text: res.message ||
                                'Data kalibrasi dimensi berhasil disimpan.',
                            timer: 2000,
