...
@section('title', 'Master Jangka Sorong')
            ...
            <div class="card shadow-sm border-0 rounded-3">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-bold text-primary">
                        <i class="mdi mdi-ruler me-2"></i> Master Jangka Sorong
                    </h5>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#formMaster').submit(function(e) {
                ...
                const id = $('#id').val();
                const url = id ?
                    "{{ route('jangka-sorong.update', ':id') }}".replace(':id', id) :
                    "{{ route('jangka-sorong.store') }}";
            ...
            $(document).on('click', '.btnDelete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ url('kalibrasi/master/jangka-sorong') }}/" + id,
                            type: 'DELETE',
                            data: {
                                _token: "{{ csrf_token() }}"
                            },
