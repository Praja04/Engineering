                            ...
                            $.each(response.data, function(i, item) {
                                rows += `
                                    <tr>
                                        ...
                                        <td class="text-center">${formatKoreksi(item.max_koreksi)}</td>
                                        <td class="text-center">
                                            <span class="${badgeStatus(item.status)} text-uppercase">${item.status.replace('_',' ')}</span>
                                        </td>
                                        <td class="text-center">
