...
<html lang="id" data-theme="light">
    ...
    <head>
        ...
        <title>Engineering | EJO Portal</title>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500;600;700;800&display=swap"
            rel="stylesheet">
        <!-- Lucide Icons -->
        <script src="/ejo-engineer-assets/lucide.min.js"></script>
        <!-- Chart.js -->
    ...
    <body>
            ...
            <aside class="sidebar">
                <div class="sidebar-brand">
                    <div class="logo-icon" onclick="switchTab('overview')" style="cursor: pointer;"
                        ...
                        <img src="/ejo-engineer-assets/Logo-BAS.png" alt="Logo PT. Bumi Alam Segar">
                    </div>
                </div>
                    ...
                    <nav class="sidebar-nav">
                        ...
                        <div class="nav-item-wrapper">
                            ...
                            <div class="sidebar-submenu submenu" id="drawing-gallery-submenu"
                                ...
                                <button class="nav-btn sub-btn" data-tab="drawing-gallery"
                                    data-gallery-category="sipil" style="display: none !important;">
                                    <i data-lucide="building-2"></i>
                                    <span>Drawing Sipil</span>
                                </button>
                                <button class="nav-btn sub-btn" data-tab="drawing-gallery"
                                    data-gallery-category="mekanik" style="display: none !important;">
                                    <i data-lucide="wrench"></i>
                                    <span>Drawing Mekanik</span>
                                </button>
                                <button class="nav-btn sub-btn" data-tab="partlist-gallery"
                                    id="btn-nav-partlist-gallery" style="display: none !important;">
            ...
            <main class="main-content">
                ...
                <header class="app-header">
                    ...
                    <div class="header-right">
                        ...
                        <button class="notification-btn cursor-pointer" id="btn-fullscreen-toggle"
                            title="Layar Penuh">
                ...
                <div class="workspace-body">
                        ...
                        <div class="kpi-grid">
                            <div class="kpi-card card-glass glow-blue" id="kpi-card-total">
                                ...
                                <div class="kpi-data">
                                    ...
                                    <span class="kpi-trend text-blue" id="kpi-total-sub"><i
                        ...
                        <div class="overview-split-layout" id="overview-split-layout">
                            <div class="overview-main-col">
                                ...
                                <div class="chart-card card-glass" id="card-trend-chart"
                                    ...
                                    <div class="card-header">
                                        <div class="card-header-left">
                                            ...
                                            <div>
                                                <h3>Tren EJO <span id="tv-val-period" class="tv-period-inline">- Tahun
                                                        Ini (Semua Kategori)</span></h3>
                                            </div>
                                        </div>
                                        <div class="card-actions">
                                            <!-- ponytail: Filter Kategori Kerja & Drawing trend chart -->
                                            <select id="trend-category-filter" class="chart-time-filter"
                                ...
                                <div class="dashboard-summary-grid">
                                    ...
                                    <div class="kpi-card card-glass glow-cyan dashboard-summary-card"
                                        id="overview-card-gejo" onclick="switchTab('general-ejo')">
                                                ...
                                                <div id="overview-gejo-kpi-container"
                                                    ...
                                                    <div
                                                        ...
                                                        <span class="total-label"
                                                            ...
                                                            KPI Terealisasi
                                                            <button class="btn"
                                                                id="overview-gejo-kpi-realisasi-edit-btn"
                                                                style="display: none; background: none; border: none; color: var(--color-cyan); cursor: pointer; padding: 0; display: inline-flex; align-items: center;"
                                    ...
                                    <div class="kpi-card card-glass glow-blue dashboard-summary-card"
                                        id="overview-card-drawing" onclick="switchTab('drawing')">
                                        <div class="summary-card-header">
                                            <div style="display: flex; align-items: center; gap: 12px;">
                                                <div class="kpi-icon icon-blue">
                                                    <i data-lucide="image"></i>
                                                ...
                                                <div id="overview-drawing-kpi-container"
                                                    ...
                                                    <div
                                                        ...
                                                        <span class="total-label"
                                                            ...
                                                            KPI Terealisasi
                                                            <button class="btn"
                                                                id="overview-drawing-kpi-realisasi-edit-btn"
                                                                style="display: none; background: none; border: none; color: var(--color-blue); cursor: pointer; padding: 0; display: inline-flex; align-items: center;"
                                                        ...
                                                        <span id="overview-drawing-kpi-realisasi-val"
                                                            class="kpi-value"
                                                            style="color: var(--color-blue); margin: 0; line-height: 1; font-size: 1.4rem; font-weight: 850;">0%</span>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card-header">
                                            <div class="card-header-left">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-secondary text-xs">Distribusi penanganan order saat
                                                        ini.</p>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="overview-activity-col" id="overview-eng-activity-panel">
                                <div class="list-card card-glass eng-activity-card">
                                    <div class="card-header"
                                        style="margin-bottom: 0.75rem; padding-bottom: 0.75rem; border-bottom: 1px solid var(--card-border);">
                                        <div class="card-header-left" style="gap: 10px;">
                                            ...
                                            <div>
                                                <h3
                                                    style="font-size: 0.98rem; font-weight: 700; color: var(--text-primary); display: flex; align-items: center; gap: 6px;">
                                                    Log Aktivitas Engineer
                                                    <span class="badge badge-accent badge-live"
                                                        style="font-size: 0.65rem; padding: 2px 6px;">Live</span>
                                                </h3>
                                                <p class="text-secondary text-xs"
                                                    style="margin: 2px 0 0 0; font-size: 0.72rem;">Rekap interaksi &
                                                    pembaruan teknisi realtime</p>
                                            </div>
                                        </div>
                                        <div class="card-actions">
                                            <span class="badge" id="eng-activity-total-badge"
                                                style="background: rgba(6, 182, 212, 0.12); color: var(--color-cyan); font-size: 0.72rem; font-weight: 600; padding: 3px 8px; border-radius: 12px; border: 1px solid rgba(6, 182, 212, 0.25);">0
                                                Log</span>
                                        </div>
                                    </div>
                    ...
                    <section id="tab-general-ejo" class="tab-pane">
                            ...
                            <div class="filters-wrapper">
                                <div class="filter-group" style="display: none;">
                                    ...
                                    <select id="gejo-filter-status">
                                        ...
                                        <option value="Pending Approval">Pending Approval (Menunggu Verifikasi)
                                        </option>
                                ...
                                <div class="filter-group filter-group-date-range">
                                    ...
                                    <div class="date-range-row" style="display: flex; align-items: center; gap: 6px;">
                                        <input type="date" id="gejo-filter-start-date"
                                            class="form-control date-range-input" title="Dari Tanggal">
                                        <span class="date-separator"
                                            style="color: var(--text-secondary, #94a3b8); font-size: 0.75rem; font-weight: 600; flex-shrink: 0;">s/d</span>
                                        <input type="date" id="gejo-filter-end-date"
                                            class="form-control date-range-input" title="Sampai Tanggal">
                                    </div>
                                </div>
                            </div>
                            ...
                            <form id="gejo-form">
                                <div class="form-grid">
                                    <div class="form-field full-width">
                                        <label for="gejo-form-title">Judul Pekerjaan <span
                                    ...
                                    <div class="form-field">
                                        <label for="gejo-form-priority">Prioritas <span
                                                class="required">*</span></label>
                                        <select id="gejo-form-priority" required>
                                            <option value="1">1 - High (Urgent / Line Stop / Bahaya HSE / PEST)
                                            </option>
                                    ...
                                    <div class="form-field">
                                        <label for="gejo-form-target-date">Target Selesai <span
                                                style="font-size: 0.75rem; color: var(--color-amber, #f59e0b); font-weight: 500;">(Menyesuaikan
                                                Jadwal Engineer)</span></label>
                                    ...
                                    <div class="form-field gejo-repair-field" style="display: none;">
                                        <label for="gejo-form-price-new">Harga by SAP <span
                                                class="required">*</span></label>
                                        <input type="number" id="gejo-form-price-new" min="0"
                                    ...
                                    <div class="form-field gejo-repair-field" style="display: none;">
                                        <label for="gejo-form-qty-needed">Quantity yang Diperlukan Mesin <span
                                                class="required">*</span></label>
                                        <input type="number" id="gejo-form-qty-needed" min="0"
                                            value="0" placeholder="0">
                                    </div>
                                    <div class="form-field gejo-repair-field" style="display: none;">
                                        <label for="gejo-form-qty-stock">Quantity Stok (Hasil Pengurangan / Target
                                            Stok)</label>
                                        <input type="number" id="gejo-form-qty-stock" min="0" value="0"
                                            placeholder="0">
                                    </div>
                                    <div class="form-field" style="display: none;">
                                        ...
                                        <div style="width: 100%; position: relative;">
                                            ...
                                            <div id="gejo-file-before-trigger"
                                                ...
                                                <span id="gejo-file-before-filename"
                                                    style="font-size: 0.8rem; color: var(--text-secondary); text-align: center; word-break: break-all; font-weight: 500;">Upload/take
                                                    Foto</span>
                                            </div>
                                        </div>
                                ...
                                <div class="form-actions border-top" style="margin-top: 1rem; padding-top: 1rem;">
                                    <button type="button" class="btn btn-secondary"
                                        id="gejo-btn-cancel-form">Batal</button>
                                    <button type="submit" class="btn btn-primary glow-button"
                                        id="gejo-form-submit-btn">
                        ...
                        <div class="project-board" id="gejo-kanban-board" style="display: none;">
                            ...
                            <div class="gejo-outstanding-group" id="gejo-outstanding-group">
                                ...
                                <div class="gejo-outstanding-columns">
                                    ...
                                    <div class="project-column card-glass" id="gejo-col-fase1">
                                        <div class="column-header ch-fase1" onclick="navigateToGeneralEjoPhase(1)"
                                            title="Klik untuk Buka Submenu Schedule">
                                    ...
                                    <div class="project-column card-glass" id="gejo-col-fase2">
                                        <div class="column-header ch-fase2" onclick="navigateToGeneralEjoPhase(2)"
                                            title="Klik untuk Buka Submenu On Progress">
                                            <!-- ponytail: show only Schedule/On Progress/Done names in headers, removing Fase prefix and extra details -->
                                            <h4>On Progress</h4>
                            ...
                            <div class="project-column card-glass" id="gejo-col-fase3">
                                <div class="column-header ch-fase3" onclick="navigateToGeneralEjoPhase(3)"
                                    title="Klik untuk Buka Submenu Done">
                                    <!-- ponytail: show only Schedule/On Progress/Done names in headers, removing Fase prefix and extra details -->
                                    <h4>Done</h4>
                            ...
                            <div class="project-column card-glass" id="gejo-col-fase4" style="display: none;">
                                <div class="column-header ch-archive" onclick="navigateToGeneralEjoPhase(4)"
                                    title="Klik untuk Buka Submenu Archive">
                                    <h4>Archive</h4>
                    ...
                    <section id="tab-drawing" class="tab-pane">
                            ...
                            <div class="filters-wrapper">
                                <div class="filter-group">
                                    ...
                                    <select id="drawing-filter-status">
                                        ...
                                        <option value="Pending Supervisor Approval">Pending Supervisor Approval
                                        </option>
                        ...
                        <div id="drawing-form-container" class="card-glass"
                            ...
                            <form id="drawing-form">
                                <div class="form-grid">
                                    <div class="form-field">
                                        <label for="drawing-title">Judul Drawing <span
                                                class="required">*</span></label>
                                        <input type="text" id="drawing-title"
                                            placeholder="Contoh: Layout panel MCC line 2" required>
                                    </div>
                                    <div class="form-field">
                                    ...
                                    <div class="form-field">
                                        <label for="drawing-form-priority">Prioritas <span
                                                class="required">*</span></label>
                                        <select id="drawing-form-priority" required>
                                            <option value="1">1 - High (Urgent / Line Stop / Bahaya HSE / PEST)
                                            </option>
                                            <option value="2">2 - Medium (Normal Kerja)</option>
                                            <option value="3" selected>3 - Rutin (Rutin / Tidak Mendesak)
                                            </option>
                                        </select>
                                    </div>
                                    <div class="form-field">
                                    ...
                                    <div class="form-field full-width">
                                        <label for="drawing-form-location">Lokasi <span
                                                class="required">*</span></label>
                                    ...
                                    <div class="form-field full-width">
                                        ...
                                        <textarea id="drawing-form-description" rows="3" placeholder="Jelaskan detail drawing yang dibutuhkan..."></textarea>
                                    </div>
                        ...
                        <div class="project-board" id="drawing-kanban-board">
                            ...
                            <div class="gejo-outstanding-group" id="drawing-outstanding-group">
                                ...
                                <div class="gejo-outstanding-columns">
                                    ...
                                    <div class="project-column card-glass" id="drawing-col-phase1">
                                        <div class="column-header ch-fase1" onclick="navigateToDrawingPhase(1)"
                                            title="Klik untuk Buka Submenu Schedule">
                                            <h4>Schedule</h4>
                                    ...
                                    <div class="project-column card-glass" id="drawing-col-phase2">
                                        <div class="column-header ch-fase2" onclick="navigateToDrawingPhase(2)"
                                            title="Klik untuk Buka Submenu On Progress">
                                            <h4>On Progress</h4>
                            ...
                            <div class="project-column card-glass" id="drawing-col-phase3">
                                <div class="column-header ch-fase3" onclick="navigateToDrawingPhase(3)"
                                    title="Klik untuk Buka Submenu Done">
                                    <h4>Done</h4>
                            ...
                            <div class="project-column card-glass" id="drawing-col-phase4" style="display: none;">
                                <div class="column-header ch-archive" onclick="navigateToDrawingPhase(4)"
                                    title="Klik untuk Buka Submenu Archive">
                                    <h4>Archive</h4>
                    ...
                    <section id="tab-projects" class="tab-pane">
                        ...
                        <div id="project-form-container" class="card-glass"
                            ...
                            <form id="project-form">
                                <div class="form-grid">
                                    <div class="form-field full-width">
                                        <label for="proj-title">Judul / Nama Project <span
                                                class="required">*</span></label>
                                        <input type="text" id="proj-title"
                                            placeholder="Contoh: Otomatisasi Sistem CIP (Clean In Place) Line 2"
                                            required>
                                    </div>
                                    <div class="form-field">
                                        <label for="proj-no-io">No IO <span class="required">*</span></label>
                                        <input type="text" id="proj-no-io" placeholder="Contoh: IO-2026-089"
                                            required>
                                    </div>
                                    <div class="form-field">
                                        <label for="proj-no-moc">No MOC <span class="required">*</span></label>
                                        <input type="text" id="proj-no-moc" placeholder="Contoh: MOC-2026-012"
                                            required>
                                    </div>
                                    <div class="form-field full-width">
                                        <label for="proj-dept">Departemen Pemilik <span
                                                class="required">*</span></label>
                                    ...
                                    <div class="form-field full-width">
                                        <label for="proj-form-drawing-search">Autodetect Galeri Drawing <span
                                                style="font-size: 0.75rem; color: var(--text-muted); font-weight: normal;">(Cari
                                                Drawing Sipil, Mekanik, atau Spare Part dari Galeri)</span></label>
                                        <input type="text" id="proj-form-drawing-search"
                                            list="proj-drawing-datalist"
                                    ...
                                    <div class="form-field" style="display: none;">
                                        <label for="proj-budget">Anggaran Rencana (CapEx - Rp) <span
                                                class="required">*</span></label>
                                        <input type="number" id="proj-budget" placeholder="Contoh: 120000000"
                                            min="0">
                                    </div>
                                    <div class="form-field full-width">
                                    ...
                                    <div class="form-field full-width">
                                        <label for="proj-attachment">File Pendukung (PDF / JPG / PNG /
                                            Sejenis)</label>
                                ...
                                <div class="form-actions border-top" style="margin-top: 1rem; padding-top: 1rem;">
                                    <button type="button" class="btn btn-secondary"
                                        id="btn-cancel-project">Batal</button>
                                    <button type="submit" class="btn btn-primary glow-button">
                        ...
                        <div class="project-board">
                            ...
                            <div class="project-column card-glass" id="col-fase1">
                                <div class="column-header ch-fase1" onclick="navigateToProjectPhase(1)"
                                    title="Klik untuk Buka Submenu Fase 1: Inisialisasi">
                            ...
                            <div class="project-column card-glass" id="col-fase2">
                                <div class="column-header ch-fase2" onclick="navigateToProjectPhase(2)"
                                    title="Klik untuk Buka Submenu Fase 2: Pengadaan">
                            ...
                            <div class="project-column card-glass" id="col-fase3">
                                <div class="column-header ch-fase3" onclick="navigateToProjectPhase(3)"
                                    title="Klik untuk Buka Submenu Fase 3: Eksekusi">
                            ...
                            <div class="project-column card-glass" id="col-fase4">
                                <div class="column-header ch-fase4" style="border-top-color: #10b981;"
                                    onclick="navigateToProjectPhase(4)"
                                    title="Klik untuk Buka Submenu Fase 4: Commissioning & Serah Terima">
                            ...
                            <div class="project-column card-glass" id="col-fase5" style="display: none;">
                                <div class="column-header ch-fase5" style="border-top-color: var(--color-cyan);"
                                    onclick="navigateToProjectPhase('archive')"
                                    title="Klik untuk Buka Submenu Arsip Project">
                                    <span class="phase-number"
                        ...
                        <div id="part-form-container" class="card-glass"
                            ...
                            <form id="part-form">
                                <div class="form-grid">
                                    ...
                                    <div class="form-field">
                                        <label for="part-ejo-mid">Machine ID (MID) <span
                                                class="required">*</span></label>
                                        <input type="text" id="part-ejo-mid" placeholder="Contoh: MC-001"
                                            required>
                                    </div>
                                    <div class="form-field">
                                        <label for="part-ejo-priority">Prioritas <span
                                                class="required">*</span></label>
                                    ...
                                    <div class="form-field">
                                        <label for="part-ejo-price-new">Harga SAP (Rp) <span
                                                class="required">*</span></label>
                                        <input type="number" id="part-ejo-price-new" min="0"
                                    ...
                                    <div class="form-field full-width">
                                        <label for="part-ejo-subject">Subject <span
                                                class="required">*</span></label>
                                ...
                                <div class="form-actions border-top" style="margin-top: 1rem; padding-top: 1rem;">
                                    <button type="button" class="btn btn-secondary"
                                        id="btn-cancel-part">Batal</button>
                                    <button type="submit" class="btn btn-primary glow-button">
                        ...
                        <div id="sparepart-form-container" class="card-glass"
                            ...
                            <form id="sparepart-form">
                                <div class="form-grid">
                                    ...
                                    <div class="form-field full-width">
                                        <label>Detail Gambar / Dokumen Spare Part <span
                                                class="required">*</span></label>
                                        <div style="width: 100%; position: relative;">
                                ...
                                <div class="form-actions border-top" style="margin-top: 1rem; padding-top: 1rem;">
                                    <button type="button" class="btn btn-secondary"
                                        id="btn-cancel-sparepart">Batal</button>
                                    <button type="submit" class="btn btn-primary glow-button">
                            ...
                            <div class="chart-card card-glass">
                                <div class="card-header">
                                    <div class="card-header-left">
                                        ...
                                        <div>
                                            <h3>Volume EJO Repair Part Masuk, Selesai &amp; OS <span
                                                    id="partlist-tv-val-period" class="tv-period-inline">- Tahun
                                                    Ini</span></h3>
                                        </div>
                                    </div>
                                    <div class="card-actions">
                            ...
                            <div class="chart-card card-glass">
                                <div class="card-header">
                                    <div class="card-header-left">
                                        ...
                                        <div>
                                            <h3>Perbandingan Biaya Dan Penghematan <span id="partlist-cost-val-period"
                                                    class="tv-period-inline">- Tahun Ini</span></h3>
                                        </div>
                                    </div>
                                    <div class="card-actions">
                        ...
                        <div class="job-table-view card-glass" id="partlist-ejo-table-wrapper"
                            ...
                            <h3
                                ...
                                <i data-lucide="clipboard-list"
                                    style="width: 18px; height: 18px; color: var(--color-cyan);"></i> Daftar EJO
                                Repair Part
                                (Ticket)
                            </h3>
                            <table class="data-table">
                    ...
                    <section id="tab-drawing-gallery" class="tab-pane">
                        ...
                        <div id="drawing-gallery-empty"
                            ...
                            <p style="font-size: 0.95rem; font-weight: 500;">Belum ada gambar drawing yang di-upload
                                untuk
                                kategori ini.</p>
                            <p style="font-size: 0.8rem; margin-top: 4px;">Upload drawing melalui menu <strong>Drawing
                                    EJO →
                    ...
                    <section id="tab-partlist-gallery" class="tab-pane">
                        ...
                        <div class="control-bar card-glass"
                            ...
                            <div style="display: flex; align-items: center; gap: 10px;">
                                <div class="search-wrapper"
                                    ...
                                    <input type="text" id="search-partlist-gallery"
                                        list="gallery-part-datalist" placeholder="Cari nama / kode spare part...">
                        ...
                        <div id="partlist-gallery-empty"
                            ...
                            <i data-lucide="image-off"
                                style="width: 48px; height: 48px; opacity: 0.3; margin-bottom: 1rem;"></i>
                            <p style="font-size: 0.95rem; font-weight: 500;">Belum ada gambar spare part yang
                                diupload.</p>
                            <p style="font-size: 0.8rem; margin-top: 4px;">Upload gambar melalui menu
                                <strong>Dashboard Part
                    ...
                    <section id="tab-history" class="tab-pane">
                        <div class="control-bar card-glass"
                            ...
                            <div style="min-width: 240px;">
                                ...
                                <p id="history-card-subtitle" class="text-secondary text-xs"
                            ...
                            <table class="data-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th id="history-header-action" style="display: none; text-align: right;">
                                            Aksi</th>
                    ...
                    <section id="tab-admin" class="tab-pane">
                        ...
                        <div class="control-bar card-glass"
                            ...
                            <div>
                                ...
                                <p class="text-secondary text-xs" style="margin-top:2px;">Daftarkan, kelola, dan
                                    perbarui
                                    kredensial login teknisi serta admin pabrik PT. BAS.</p>
                            </div>
                            <div style="display: flex; gap: 10px; align-items: center; flex-wrap: wrap;">
                                <button class="btn btn-outline" id="btn-seed-based-accounts"
                                    style="display: none; gap: 8px; color: var(--color-cyan); border-color: rgba(6, 182, 212, 0.4);">
                        ...
                        <div class="card-glass" id="server-db-control-bar"
                            ...
                            <div
                                ...
                                <div style="display: flex; align-items: center; gap: 12px;">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-secondary text-xs" style="margin-top: 3px;">Hapus database
                                            per modul
                                        ...
                                        <div style="display: flex; align-items: flex-start; gap: 10px;">
                                            ...
                                            <div>
                                                <h4
                                                    ...
                                                    General EJO</h4>
                                                <p class="text-secondary text-xs"
                                                    style="margin: 2px 0 0 0; line-height: 1.3;">Hapus semua tiket
                                                    General
                                                    EJO (Fase 1-3).</p>
                                            </div>
                                        </div>
                                    ...
                                    <div
                                        ...
                                        <div style="display: flex; align-items: flex-start; gap: 10px;">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-secondary text-xs"
                                                    style="margin: 2px 0 0 0; line-height: 1.3;">Hapus seluruh kartu
                                                    Project
                                                    (Fase 1-4).</p>
                                            </div>
                                        </div>
                                    ...
                                    <div
                                        ...
                                        <div style="display: flex; align-items: flex-start; gap: 10px;">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-secondary text-xs"
                                                    style="margin: 2px 0 0 0; line-height: 1.3;">Hapus data Repair
                                                    Part
                                                    &amp; galeri spare part.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div style="display: flex; align-items: flex-start; gap: 10px;">
                                            ...
                                            <div>
                                                <h4
                                                    ...
                                                    Akun Personel</h4>
                                                <p class="text-secondary text-xs"
                                                    style="margin: 2px 0 0 0; line-height: 1.3;">Reset akun pengguna
                                                    ke
                                                    default pabrik.</p>
                                            </div>
                                        </div>
                            ...
                            <div
                                ...
                                <div style="display: flex; align-items: center; gap: 12px;">
                                    ...
                                    <div>
                                        <h4 style="font-size: 0.95rem; font-weight: 700; color: #f59e0b; margin: 0;">
                                            Hapus Seluruh Data Modul (Kecuali Akun Personel)</h4>
                                        <p class="text-secondary text-xs" style="margin: 2px 0 0 0;">Hapus seluruh
                                            data tiket General EJO, Drawing, Project, Galeri, Dashboard Spare Part,
                                            &amp; History sekaligus tanpa menghapus akun pengguna.</p>
                                    </div>
                                </div>
                                <button class="btn" id="btn-reset-all-modules"
                                    ...
                                    <i data-lucide="trash-2" style="width: 16px; height: 16px;"></i> Hapus Semua
                                    Data (Keep Akun)
                                </button>
                            </div>
                            ...
                            <div
                                ...
                                <div style="display: flex; align-items: center; gap: 12px;">
                                    ...
                                    <div>
                                        <h4 style="font-size: 0.95rem; font-weight: 700; color: #f43f5e; margin: 0;">
                                            Zona
                        ...
                        <div class="control-bar card-glass"
                            ...
                            <div>
                                ...
                                <p class="text-secondary text-xs" style="margin-top:2px;">Ekspor seluruh riwayat Job
                                    Order
                                    ke file Excel atau impor dari file template Excel PT. BAS.</p>
                            </div>
                            <div style="display: flex; gap: 10px; align-items: center; flex-wrap: wrap;">
                                <!-- ponytail: Temporarily hide Excel export button per user request -->
                                <button class="btn btn-outline" id="btn-excel-export"
                                ...
                                <button class="btn btn-outline" id="btn-excel-import-drawing"
                                    ...
                                    <i data-lucide="file-image" style="width: 16px; height: 16px;"></i> Import
                                    Drawing EJO
                                </button>
                                ...
                                <button class="btn btn-outline" id="btn-wsp-admin-import"
                                    ...
                                    <i data-lucide="file-spreadsheet" style="width: 16px; height: 16px;"></i> Import
                                    WSP
                                    Material
                                </button>
                        ...
                        <div class="control-bar card-glass"
                            ...
                            <div style="display: flex; align-items: center; gap: 10px;">
                                ...
                                <span
                                    style="font-size: 0.9rem; font-weight: 500; color: var(--text-primary);">Proporsi
                                    Status EJO</span>
                            </div>
                        </div>
                            ...
                            <form id="user-admin-form">
                                ...
                                <div class="form-grid">
                                    <div class="form-field">
                                        ...
                                        <input type="text" id="usr-username"
                                            placeholder="Contoh: dani (lowercase, unik)" required>
                                        <small id="usr-username-duplicate-hint"
                                            style="display: none; color: var(--danger-color, #ef4444); font-size: 0.75rem; margin-top: 4px;">⚠️
                                            Username ini sudah terdaftar oleh user lain. Silakan pilih username lain
                                            atau
                                    ...
                                    <div class="form-field" id="user-password-field-container">
                                        ...
                                        <div class="password-input-wrapper">
                                            ...
                                            <button type="button" class="btn-toggle-password"
                                                id="btn-toggle-usr-pass" title="Tampilkan Password">
                                    ...
                                    <div class="form-field">
                                        <label for="usr-fullname">Nama Lengkap Personel <span
                                                class="required">*</span></label>
                                        <input type="text" id="usr-fullname" placeholder="Contoh: Ahmad Dani"
                                            required>
                                    </div>
                                    <div class="form-field">
                                        <label for="usr-section">Bagian / Sub-Divisi</label>
                                        <input type="text" id="usr-section"
                                            placeholder="Contoh: PRD Proses, WWTP, Sipil 1, PM Retail">
                                    </div>
                                    <div class="form-field">
                                    ...
                                    <div class="form-field">
                                        ...
                                        <select id="usr-role" required disabled>
                                            <option value="" disabled selected id="role-placeholder">Pilih
                                                Departemen
                                ...
                                <div class="form-actions border-top" style="margin-top: 1rem; padding-top: 1rem;">
                                    <button type="button" class="btn btn-secondary"
                                        id="btn-cancel-user-form">Batal</button>
                                    <button type="submit" class="btn btn-primary glow-button"
                        ...
                        <div class="control-bar card-glass"
                            ...
                            <div>
                                <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 4px;">
                                    ...
                                    <h3 style="font-size: 1.2rem; font-weight:700;">Perizinan Tampil Modul Dashboard
                                    </h3>
                                    <span class="badge"
                                ...
                                <p class="text-secondary text-xs">Atur visibilitas setiap widget, komponen KPI, chart,
                                    dan
                        ...
                        <div id="server-access-main-container">
                                ...
                                <div>
                                    <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 4px;">
                                        <i data-lucide="shield-check"
                                            style="color: var(--color-cyan); width: 20px; height: 20px;"></i>
                                        <h3 style="font-size: 1.2rem; font-weight:700;">Manajemen Akses & Otoritas
                                            Server
                                        </h3>
                                        <span class="badge"
                                    ...
                                    <p class="text-secondary text-xs">Kelola hak akses modul, status otoritas, dan
                                        atribusi
                                        per Role & Departemen secara terpusat.</p>
                                </div>
                                <div style="display: flex; gap: 10px; align-items: center;">
                                    <button class="btn btn-primary" id="btn-server-access-add-user"
                                        style="gap: 8px;">
                            ...
                            <div class="stats-grid"
                                ...
                                <div class="card-glass stat-card"
                                    ...
                                    <div>
                                        <span class="text-secondary text-xs" style="font-weight: 500;">Total
                                            Dept</span>
                                ...
                                <div class="card-glass stat-card"
                                    ...
                                    <div>
                                        <span class="text-secondary text-xs" style="font-weight: 500;">User
                                            Online</span>
                            ...
                            <div class="card-glass"
                                ...
                                <div
                                    ...
                                    <div class="search-box"
                                        style="position: relative; width: 100%; max-width: 320px;">
                                ...
                                <div style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
                                    <button id="btn-server-access-bulk-default" type="button"
                                        class="btn btn-outline btn-xs" onclick="bulkResetAllUsersToDefaultRole()"
                                        ...
                                        <i data-lucide="rotate-ccw" style="width: 14px; height: 14px;"></i> Bulk
                                        Reset to
                                        Default Role
                                    </button>
                                    <div
                                        ...
                                        <button id="server-access-mode-role" type="button" class="btn btn-xs"
                                            ...
                                            <i data-lucide="layers" style="width: 14px; height: 14px;"></i> Per Role
                                            & Dept
                                        </button>
                                        <button id="server-access-mode-user" type="button" class="btn btn-xs"
                                            ...
                                            <i data-lucide="user" style="width: 14px; height: 14px;"></i> Per Akun
                                            Personel
                                        </button>
                                    </div>
                                </div>
                ...
                <div class="modal-header"
                    ...
                    <div style="display: flex; align-items: center; gap: 12px;">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 2px;">
                            ...
                            <p style="margin: 0; font-size: 0.78rem; color: var(--text-muted); line-height: 1.3;">
                                Transfer
                ...
                <form id="transfer-drawing-project-form" onsubmit="submitTransferDrawingToProject(event)"
                    ...
                    <div
                        ...
                        <button type="button" class="btn btn-outline"
                            onclick="closeTransferDrawingToProjectModal()"
                ...
                <div class="modal-body">
                    <div class="modal-main-info">
                        ...
                        <div class="ejo-meta-fields">
                            ...
                            <div class="meta-field">
                                <span class="meta-label"><i data-lucide="calendar"></i> Target Selesai
                                    (Requester)</span>
                            ...
                            <div class="cost-analysis-card" id="modal-ejo-qty-analysis-field"
                                style="display: none;">
                                <div class="cost-analysis-header">
                        ...
                        <div class="details-section">
                            <h4><i data-lucide="align-left" style="color: var(--color-cyan);"></i> Deskripsi Masalah
                                / Ruang
                                Lingkup</h4>
                        ...
                        <div class="details-section" id="modal-ejo-urgent-section" style="display: none;">
                            <h4 style="color: var(--color-rose); border-bottom-color: rgba(244, 63, 94, 0.2);"><i
                                    data-lucide="alert-triangle" style="color: var(--color-rose);"></i> Alasan
                                Urgent</h4>
                        ...
                        <div class="details-section" id="modal-ejo-photo-before-section" style="display: none;">
                            <h4><i data-lucide="camera" style="color: var(--color-blue);"></i> Foto Before (Kondisi
                                Awal)
                            </h4>
                            <div class="photo-before-container">
                                <a id="modal-ejo-photo-before-link" href="#" target="_blank"
                                    class="photo-before-wrapper">
                        ...
                        <div class="details-section" id="modal-ejo-photo-after-section" style="display: none;">
                            <h4 style="color: var(--color-green); border-bottom-color: rgba(16, 185, 129, 0.15);"><i
                                    data-lucide="camera" style="color: var(--color-green);"></i> Foto After (Kondisi
                                Setelah
                                Pekerjaan)</h4>
                        ...
                        <div class="details-section" id="modal-ejo-completion-report-section"
                            style="display: none;">
                            <h4 class="completion-section-title"><i data-lucide="check-circle-2"
                                    style="color: var(--color-green);"></i> Laporan Hasil Pekerjaan (Drafter/Engineer)
                            </h4>
                        ...
                        <div class="details-section" id="modal-ejo-revision-instruction-section"
                            style="display: none;">
                    ...
                    <div class="modal-action-sidebar">
                        ...
                        <div class="action-card" id="card-work-reports" style="margin-top: 1rem;">
                            <h4>Laporan & Log Pekerjaan</h4>
                            <!-- ponytail: added template options for completion notes -->
                        ...
                        <div class="action-card" id="card-status-update" style="margin-top: 1rem;">
                            ...
                            <div class="status-btn-group" id="modal-status-btn-group">
                                ...
                                <button class="btn btn-outline btn-danger btn-status-change"
                            ...
                            <div id="checking-sub-options"
                                ...
                                <label
                                    style="font-size: 0.8rem; font-weight: 600; color: var(--text-secondary);">Sub-status
                                    Checking:</label>
                                <div style="display: flex; gap: 1.5rem; align-items: center;">
                                    <label
                                        style="display: flex; align-items: center; gap: 0.35rem; font-size: 0.85rem; cursor: pointer; color: var(--text-primary);">
                                        <input type="checkbox" name="checking-sub-type" value="Drawing Ready"
                                            checked>
                                        Drawing Ready
                                    </label>
                                    <label
                        ...
                        <button class="btn btn-danger-outline full-width" id="btn-delete-ejo"
            ...
            <div class="modal-card card-glass animate-in" style="max-width: 650px;">
                ...
                <div class="modal-body" style="grid-template-columns: 1fr; gap: 1.5rem;">
                    <div class="modal-main-info" style="border-right: none; padding-right: 0; width: 100%;">
                        ...
                        <div id="modal-part-image-container"
                ...
                <div class="modal-body" style="grid-template-columns: 1fr; gap: 1.5rem;">
                    <div class="modal-main-info" style="border-right: none; padding-right: 0; width: 100%;">
                        ...
                        <p class="text-secondary" style="margin-top: -0.25rem; font-size: 0.85rem;">
                            <i data-lucide="user"
                                style="width: 14px; height: 14px; display: inline; vertical-align: middle; margin-right: 4px;"></i>
                            Pengusul: <strong id="modal-project-pic"
                                style="color: var(--text-primary);">Foreman</strong> |
                        ...
                        <div
                            ...
                            <span id="modal-project-phase" class="badge badge-accent">Fase 1: Inisialisasi
                                Ide</span>
                        ...
                        <div id="project-boq-docs-sec"
                            ...
                            <h3
                                ...
                                <span style="display: flex; align-items: center; gap: 6px;"><i
                                        data-lucide="paperclip" style="width:16px;height:16px;"></i> Dokumen BOQ
                                    (Bill of Quantities)</span>
                        ...
                        <div id="project-procurement-sec"
                            ...
                            <h3
                                ...
                                <span style="display: flex; align-items: center; gap: 6px;"><i
                                        data-lucide="shopping-bag" style="width:16px;height:16px;"></i> Detail
                                    Status Procurement (PR / PO / GR)</span>
                        ...
                        <div id="project-timeline-sec"
                            ...
                            <h3
                                ...
                                <span style="display: flex; align-items: center; gap: 6px;"><i
                                        data-lucide="calendar" style="width:16px;height:16px;"></i> Timeline
                                    Eksekusi Proyek</span>
                        ...
                        <div id="project-handover-docs-sec"
                            ...
                            <h3
                                ...
                                <i data-lucide="file-check"
                                    style="width:16px;height:16px;color: var(--color-green);"></i>
                            ...
                            <div id="project-handover-signatures-sec"
                                ...
                                <div id="proj-handover-sign-action-bar"
                                    ...
                                    <button id="proj-handover-btn-sign" type="button"
                        ...
                        <div id="project-documentation-section"
                            ...
                            <input type="file" id="proj-doc-file-input" style="display: none;"
                ...
                <div class="modal-body modal-drawing-body">
                    ...
                    <div class="modal-main-info modal-drawing-main-info">
                        ...
                        <p class="text-secondary" style="margin-top: -0.25rem; font-size: 0.85rem;">
                            ...
                            <span id="modal-drawing-est-date-wrapper" style="display: none;">&bull; Est. Selesai:
                                <strong id="modal-drawing-est-date"
                                    style="color: var(--color-green);">-</strong></span>
                        </p>
                        ...
                        <div style="display: flex; gap: 10px; margin-top: 0.5rem; width: 100%;">
                            <a id="modal-drawing-download-link" href="#" target="_blank"
                    ...
                    <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                        ...
                        <div class="card-glass" id="card-drawing-assignment"
                            ...
                            <div id="drawing-assignment-view"
        ...
        <div id="urgent-reason-modal" class="modal-backdrop"
            ...
            <div class="card-glass animate-in"
                ...
                <div style="display: flex; gap: 0.65rem; align-items: center; width: 100%;">
                    ...
                    <div>
                        <h4 style="margin: 0; font-size: 1rem; font-weight: 700; color: var(--text-primary);">Alasan
                            Urgent
                            (Prioritas 1)</h4>
                    </div>
                </div>
                ...
                <div style="width: 100%;">
                    ...
                    <span id="urgent-reason-error"
                        ...
                        <i data-lucide="alert-circle"
                            style="width: 12px; height: 12px; vertical-align: middle;"></i> Alasan
                        urgent wajib diisi!
                    </span>
                </div>
                ...
                <div style="display: flex; justify-content: flex-end; gap: 0.5rem; width: 100%; margin-top: 0.25rem;">
                    <button type="button" class="btn btn-secondary btn-sm"
                        id="btn-cancel-urgent-reason">Batal</button>
        ...
        <div id="custom-prompt-modal" class="modal-backdrop"
            ...
            <div class="card-glass animate-in"
                ...
                <div id="prompt-modal-upload-container"
                    ...
                    <label style="font-size: 0.8rem; font-weight: 600; color: var(--text-secondary);">Upload Foto /
                        File
                        Pendukung:</label>
                    <div style="width: 100%; position: relative;">
        ...
        <div id="custom-procurement-modal" class="modal-backdrop"
            ...
            <div class="card-glass animate-in"
                ...
                <p
                    style="margin: 0; font-size: 0.85rem; color: var(--text-secondary); line-height: 1.4; width: 100%;">
                ...
                <div style="width: 100%; display: flex; flex-direction: column; gap: 0.85rem;">
                    <div style="display: flex; flex-direction: column; gap: 4px;">
                        ...
                        <div style="position: relative; display: flex; align-items: center;">
                            <input type="number" id="procurement-input-pr" min="0" max="100"
                                placeholder="0 - 100"
                    ...
                    <div style="display: flex; flex-direction: column; gap: 4px;">
                        ...
                        <div style="position: relative; display: flex; align-items: center;">
                            <input type="number" id="procurement-input-po" min="0" max="100"
                                placeholder="0 - 100"
                                style="width: 100%; padding: 0.6rem 2.2rem 0.6rem 0.75rem; font-size: 0.9rem; border-radius: var(--border-radius-sm); border: 1px solid var(--card-border); background: var(--bg-main); color: var(--text-primary); box-sizing: border-box;">
                            <span
                                style="position: absolute; right: 12px; font-weight: 700; color: var(--text-muted); font-size: 0.9rem;">%</span>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 4px;">
                        ...
                        <div style="position: relative; display: flex; align-items: center;">
                            <input type="number" id="procurement-input-gr" min="0" max="100"
                                placeholder="0 - 100"
                                style="width: 100%; padding: 0.6rem 2.2rem 0.6rem 0.75rem; font-size: 0.9rem; border-radius: var(--border-radius-sm); border: 1px solid var(--card-border); background: var(--bg-main); color: var(--text-primary); box-sizing: border-box;">
                            <span
                                style="position: absolute; right: 12px; font-weight: 700; color: var(--text-muted); font-size: 0.9rem;">%</span>
                    ...
                    <div
                        ...
                        <span style="color: var(--text-secondary); display: flex; align-items: center; gap: 5px;">
                            <i data-lucide="sparkles"
                                style="width: 13px; height: 13px; color: var(--color-cyan);"></i> Total Distribusi:
                        </span>
        ...
        <div id="pr-calculator-modal" class="modal-backdrop"
            ...
            <div class="card-glass animate-in"
                ...
                <div
                    ...
                    <div
                        style="font-size: 0.8rem; font-weight: 700; color: var(--color-cyan); margin-bottom: 4px; display: flex; align-items: center; gap: 4px;">
                        <i data-lucide="calculator" style="width: 13px; height: 13px;"></i> Rumus Otomatis Progress
                        PR:
                    </div>
                    <div style="font-size: 0.92rem; color: var(--text-primary); font-weight: 700; line-height: 1.4;">
                        Progress PR (%) = <span style="color: var(--color-cyan);">(Total PR + Total Ready Stock
                            WS/WSP)</span> ÷ <span style="color: #f59e0b;">Total All Material</span> × 100%
                    </div>
                </div>
                ...
                <div
                    ...
                    <div style="display: flex; align-items: flex-start; gap: 6px;">
                        ...
                        <span><strong style="color: var(--color-cyan);">Total PR</strong>: Jumlah item material yang
                            telah diterbitkan nomor Purchase Requisition.</span>
                    </div>
                    <div style="display: flex; align-items: flex-start; gap: 6px;">
                        <i data-lucide="check-circle-2"
                            style="width: 14px; height: 14px; color: #38bdf8; flex-shrink: 0; margin-top: 2px;"></i>
                        <span><strong style="color: #38bdf8;">Total Ready Stock WS/WSP</strong>: Jumlah material yang
                            sudah tersedia di Workshop / Gudang WS & WSP.</span>
                    </div>
                    <div style="display: flex; align-items: flex-start; gap: 6px;">
                        <i data-lucide="check-circle-2"
                            style="width: 14px; height: 14px; color: #f59e0b; flex-shrink: 0; margin-top: 2px;"></i>
                        <span><strong style="color: #f59e0b;">Total All Material</strong>: Keseluruhan total kebutuhan
                            item material pada proyek.</span>
                    </div>
                </div>
        ...
        <div id="drawing-upload-complete-modal" class="modal-backdrop"
            ...
            <div class="card-glass animate-in"
                ...
                <div
                    style="width: 100%; display: flex; flex-direction: column; gap: 0.35rem; box-sizing: border-box;">
                    <label for="drawing-upload-complete-etiket-category"
                        style="font-size: 0.85rem; font-weight: 600; color: var(--text-primary);">Kategori Etiket
                        <span style="color: var(--color-danger, #ef4444);">*</span></label>
                ...
                <div id="drawing-upload-complete-etiket-samples-wrapper"
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                        ...
                        <span style="font-size: 0.72rem; color: var(--text-tertiary, #9ca3af);">Klik kartu untuk
                            memilih
                            orientasi</span>
                    </div>
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                    <div style="display: flex; align-items: center; gap: 0.5rem;">
                        ...
                        <h4 id="etiket-zoom-title"
                            style="margin: 0; font-size: 1.15rem; font-weight: 700; color: var(--text-primary);">
                            Detail
                            Sampel Etiket</h4>
                    </div>
        ...
        <div id="general-ejo-approve-modal" class="modal-backdrop"
            ...
            <div class="card-glass animate-in"
                ...
                <div id="gejo-approve-drawing-container"
                    ...
                    <label style="font-size: 0.85rem; font-weight: 600; color: var(--text-primary);">Unggah Drawing
                        (PDF /
                        Gambar) <span class="required">*</span>:</label>
                    <div style="width: 100%; position: relative;">
                        <input type="file" id="gejo-approve-drawing-file" style="display: none;"
                            accept="image/*,.pdf" />
            ...
            <div class="card-glass animate-in"
                ...
                <div class="form-field" style="width: 100%;">
                    ...
                    <div class="file-upload-mock" id="gejo-complete-upload-mock"
                        ...
                        <i data-lucide="upload-cloud"
                            style="width: 28px; height: 28px; color: var(--color-cyan);"></i>
        ...
        <div id="gejo-repair-part-cost-modal" class="modal-backdrop"
            ...
            <div class="card-glass animate-in"
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                    <div style="display: flex; gap: 0.75rem; align-items: center;">
                        ...
                        <div>
                            ...
                            <span id="repair-part-cost-ejo-id" class="text-xs text-muted"
                                style="font-weight: 600;">EJO ID:
                                -</span>
                        </div>
                    </div>
                ...
                <div class="form-field" style="width: 100%; box-sizing: border-box; margin-bottom: 0.75rem;">
                    <div
                        ...
                        <label for="repair-part-cost-price-new"
                            style="font-weight: 600; font-size: 0.85rem; margin-bottom: 0;">Harga Baru Part (SAP) (Rp)
                ...
                <div
                    ...
                    <div class="form-field" style="width: 100%;">
                        <label for="repair-part-cost-quantity" style="font-weight: 600; font-size: 0.85rem;">Qty
                            Total (Pcs)
                            <span class="required">*</span></label>
                        <input type="number" id="repair-part-cost-quantity" class="input-sm"
                            placeholder="Misal: 1" readonly
                            style="width: 100%; box-sizing: border-box; height: 40px; background-color: var(--bg-muted, #f3f4f6); cursor: not-allowed; opacity: 0.85;"
                            min="1" step="1">
                    </div>

                    <div class="form-field" style="width: 100%;">
                        <label for="repair-part-cost-duration" style="font-weight: 600; font-size: 0.85rem;">Durasi
                            (Hari)
                            <span class="required">*</span></label>
                    ...
                    <div class="form-field" style="width: 100%;">
                        <label for="repair-part-cost-per-day" style="font-weight: 600; font-size: 0.85rem;">Tarif /
                            Hari
                            (Rp) <span class="required">*</span></label>
                        <input type="number" id="repair-part-cost-per-day" class="input-sm"
                            placeholder="Misal: 100000" style="width: 100%; box-sizing: border-box; height: 40px;"
                            min="0" step="any">
                    </div>
                </div>
                ...
                <div class="cost-analysis-card"
                    ...
                    <div class="cost-analysis-grid"
                        ...
                        <div class="cost-stat-item" style="display: flex; flex-direction: column;">
                            <span class="cost-stat-label"
                                style="font-size: 0.75rem; color: var(--text-muted);">Total Biaya
                                Perbaikan</span>
                        ...
                        <div class="cost-stat-item" style="display: flex; flex-direction: column;">
                            <span class="cost-stat-label" style="font-size: 0.75rem; color: var(--text-muted);">Cost
                                Saving
                                (Hemat)</span>
                ...
                <div style="display: flex; gap: 0.75rem; width: 100%; margin-top: 0.25rem;">
                    ...
                    <button type="button" class="btn btn-primary full-width glow-button"
                        id="repair-part-cost-save-btn" onclick="saveRepairPartCostModal()"
                        style="padding: 0.6rem; font-weight: 600; height: 40px;">Simpan
                        Data Biaya</button>
                </div>
            </div>
        </div>
        ...
        <div id="user-profile-modal" class="modal-backdrop"
            ...
            <div class="card-glass animate-in"
                ...
                <div
                    ...
                    <input type="file" id="profile-modal-avatar-input" accept="image/*"
                        style="display: none;">
                </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <span id="profile-modal-signature-placeholder"
                            style="font-size: 0.75rem; color: var(--text-muted); font-weight: 500;">Belum Mengunggah
                            Tanda
                            Tangan</span>
                    </div>
                    ...
                    <input type="file" id="profile-modal-signature-input" accept="image/*"
                        style="display: none;">
                </div>
                ...
                <div style="width: 100%; display: flex; flex-direction: column; gap: 0.5rem;">
                    <label for="profile-modal-password"
                        style="font-size: 0.85rem; font-weight: 600; color: var(--text-primary);">Password
                        Baru</label>
                    <div class="password-input-wrapper">
            ...
            <div class="card-glass animate-in"
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                    <div style="display: flex; gap: 0.75rem; align-items: center;">
                        ...
                        <div>
                            ...
                            <p style="margin: 2px 0 0 0; font-size: 0.75rem; color: var(--text-secondary);">Goreskan
                                tanda
                ...
                <div class="signature-pad-wrapper" id="signature-pad-wrapper"
                    ...
                    <div class="signature-pad-guide"
                        ...
                        <span
                            ...
                            Tanda Tangan</span>
                        <span style="font-size: 0.65rem; color: rgba(0, 0, 0, 0.35); font-weight: 500;">PT. BAS
                            EJO</span>
                    </div>
                </div>
                ...
                <div class="signature-pad-tools"
                    ...
                    <div class="signature-pad-tool-group" style="display: flex; align-items: center; gap: 0.4rem;">
                        <span
                            style="font-size: 0.72rem; font-weight: 600; color: var(--text-secondary);">Warna:</span>
                        <button type="button" class="signature-color-btn active" data-color="#0f172a"
                            style="background: #0f172a;" title="Hitam"></button>
                        <button type="button" class="signature-color-btn" data-color="#1e40af"
                            style="background: #1e40af;" title="Biru Gelap"></button>
                        <button type="button" class="signature-color-btn" data-color="#047857"
                            style="background: #047857;" title="Hijau Gelap"></button>
                    </div>

                    <!-- Thickness Selector -->
                    <div class="signature-pad-tool-group" style="display: flex; align-items: center; gap: 0.4rem;">
                        <span
                            style="font-size: 0.72rem; font-weight: 600; color: var(--text-secondary);">Ketebalan:</span>
                        <button type="button" class="signature-width-btn" data-width="1.8">Halus</button>
                        <button type="button" class="signature-width-btn active"
                            data-width="2.8">Standar</button>
        ...
        <div id="general-ejo-rejection-modal" class="modal-backdrop"
            ...
            <div class="card-glass animate-in"
                ...
                <div style="display: flex; gap: 0.75rem; align-items: center; width: 100%;">
                    ...
                    <h4 style="margin: 0; font-size: 1.1rem; font-weight: 700; color: var(--text-primary);">Tolak
                        Approval &
                        Kembalikan</h4>
                </div>
                ...
                <div style="width: 100%; display: flex; flex-direction: column; gap: 0.5rem;">
                    <label for="gejo-reject-reason"
                        style="font-size: 0.85rem; font-weight: 600; color: var(--text-primary);">Alasan Penolakan
                        <span style="color: var(--color-red);">*</span></label>
                    <textarea id="gejo-reject-reason" rows="3" placeholder="Masukkan alasan mengapa pekerjaan ini ditolak..."
                ...
                <div style="width: 100%; display: flex; flex-direction: column; gap: 0.5rem;">
                    ...
                    <div class="file-upload-mock" id="gejo-reject-upload-mock"
                        ...
                        <input type="file" id="gejo-reject-attachment" style="display: none;"
                            accept="image/*">
                    </div>
            ...
            <div class="modal-card card-glass animate-in excel-sheet-modal-card" style="max-width: 520px;">
                <div class="modal-header excel-sheet-modal-header">
                    <div>
                        ...
                        <p class="excel-sheet-modal-subtitle">File ini memiliki banyak sheet. Pilih satu atau beberapa
                            sheet EJO untuk diimpor sekaligus.</p>
                    </div>
                ...
                <div class="modal-body excel-sheet-modal-body">
                    <div class="excel-sheet-picker">
                        <div class="excel-sheet-toolbar">
                            <input type="text" id="excel-sheet-search" placeholder="Cari nama sheet..."
                                class="excel-sheet-search-input">
                            <div class="excel-sheet-toolbar-btns">
                                <button type="button" class="excel-sheet-toolbar-btn"
                                    id="excel-sheet-btn-select-all">Pilih Semua</button>
                                <button type="button" class="excel-sheet-toolbar-btn"
                                    id="excel-sheet-btn-deselect-all">Batal Pilih</button>
                            </div>
                        </div>
                        <div class="excel-sheet-list" id="excel-sheet-list" role="listbox"
                            aria-label="Daftar sheet excel">
                        </div>
                        <select id="excel-sheet-select" class="excel-sheet-select-native" multiple
                            aria-hidden="true" tabindex="-1">
                            <!-- Options will be added dynamically -->
                        </select>
                        <div class="excel-sheet-selected" id="excel-sheet-selected">
                            <span id="excel-sheet-selected-text">0 sheet terpilih</span>
                            <span id="excel-sheet-selected-badge"
                                style="color: var(--color-cyan); font-weight: 700;"></span>
                        </div>
                    </div>
                </div>
                <div class="excel-sheet-modal-actions">
                    <button class="btn btn-outline full-width" id="excel-sheet-btn-cancel"
                        type="button">Batal</button>
                    <button class="btn btn-primary glow-button full-width" id="excel-sheet-btn-confirm"
                        type="button">Mulai Impor</button>
                </div>
            </div>
        </div>
            ...
            <div class="modal-card card-glass animate-in" style="max-width: 450px;">
                ...
                <div class="modal-body" style="grid-template-columns: 1fr; gap: 1.5rem; padding: 1.5rem;">
                    <div style="display: flex; flex-direction: column; gap: 1rem; width: 100%;">
                        <h3 style="font-size: 1.1rem; font-weight: 700; color: var(--text-primary);">Update Persentase
                            KPI
                        </h3>
                        <p class="text-secondary text-xs">Masukkan persentase pencapaian KPI General EJO saat ini
                            (0-100)
                            untuk diperbarui setiap minggunya.</p>

                        <div style="display: flex; flex-direction: column; gap: 0.5rem; margin-top: 0.5rem;">
                            <label for="input-kpi-percentage"
                                style="font-weight: 600; font-size: 0.85rem; color: var(--text-secondary);">Persentase
                                KPI
                                (%)</label>
                            <input type="number" id="input-kpi-percentage" min="0" max="100"
                                class="input-sm" style="width: 100%;" placeholder="Contoh: 85">
                        </div>
            ...
            <div class="modal-card card-glass animate-in"
                ...
                <div class="modal-header">
                    <div class="ejo-header-badge" style="display: flex; align-items: center; gap: 8px;">
                        <span class="badge-ejo-code"
                            style="color: #f59e0b; border-color: rgba(245, 158, 11, 0.4);">TIMELINE
                            PROYEK</span>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 1rem; width: 100%;">
                        ...
                        <div
                            ...
                            <span
                                ...
                                <i data-lucide="plus-circle" style="width: 14px; height: 14px;"></i> Tambah Entri
                                Timeline
                                Baru
                            </span>
        ...
        <div id="project-execution-doc-modal" class="modal-backdrop"
            ...
            <div class="card-glass animate-in"
                ...
                <div id="proj-exec-upload-dropzone" class="file-upload-mock"
                    ...
                    <span style="font-size: 0.75rem; color: var(--text-muted);">Mendukung Langsung Kamera HP (JPG,
                        PNG,
                        WEBP)</span>
                    <input type="file" id="proj-exec-modal-file-input" style="display: none;"
                ...
                <div
                    ...
                    <div style="display: flex; align-items: center; gap: 8px;">
                        ...
                        <h4 id="image-preview-modal-title"
                            style="margin: 0; font-size: 1.1rem; font-weight: 700; color: var(--text-primary);">
                            Pratinjau
                            Foto Dokumentasi</h4>
                    </div>
                    <div style="display: flex; align-items: center; gap: 8px;">
                        <button id="image-preview-modal-delete-btn" type="button"
                        ...
                        <a id="image-preview-modal-external-btn" href="#" target="_blank"
                        ...
                        <button id="image-preview-modal-close-btn" onclick="closeImagePreviewModal()"
                            class="modal-close"
                ...
                <div class="modal-header"
                    ...
                    <div style="display: flex; align-items: center; gap: 12px;">
                        ...
                        <div>
                            ...
                            <p class="text-secondary text-xs" style="margin: 3px 0 0 0;"
                                id="modal-user-access-subtitle">
                ...
                <div class="modal-body"
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1.1fr; gap: 1rem; align-items: stretch;">
                        ...
                        <div
                            ...
                            <div style="display: flex; align-items: center; gap: 6px;">
                                <i data-lucide="zap"
                                    style="width: 13px; height: 13px; color: var(--color-cyan);"></i>
                                <label
                            ...
                            <div style="display: flex; gap: 6px; flex-wrap: wrap;">
                                <button type="button" class="btn btn-outline text-xs"
                                    ...
                                    <i data-lucide="shield-check" style="width: 12px; height: 12px;"></i> Default
                                    Role &
                                    Dept
                                </button>
                                <button type="button" class="btn btn-outline text-xs"
                                ...
                                <button type="button" class="btn btn-outline text-xs"
                                    onclick="applyAccessPreset('staff')"
                                    style="padding: 4px 8px; font-size: 0.72rem; border-radius: 6px;">
                                    Staff
                                </button>
                                <button type="button" class="btn btn-outline text-xs"
                    ...
                    <div>
                        <div
                            ...
                            <i data-lucide="layout-grid"
                                style="width: 15px; height: 15px; color: var(--color-cyan);"></i>
                                ...
                                <div class="perm-card-info">
                                    <div class="perm-card-icon"
                                        style="background: rgba(6, 182, 212, 0.12); color: #06b6d4;"><i
                                            data-lucide="layout-dashboard" style="width: 16px; height: 16px;"></i>
                                    </div>
                                    <div>
                                ...
                                <div class="perm-card-info">
                                    <div class="perm-card-icon"
                                        style="background: rgba(139, 92, 246, 0.12); color: #8b5cf6;"><i
                                            data-lucide="folder-kanban" style="width: 16px; height: 16px;"></i>
                                    </div>
                                    <div>
        ...
        <div class="modal-backdrop" id="modal-dashboard-widget-access"
            ...
            <div class="modal-card card-glass animate-in"
                ...
                <div class="modal-header widget-access-modal-header">
                    <div style="display: flex; align-items: center; gap: 12px;">
                        ...
                        <div>
                            ...
                            <p class="text-secondary text-xs" style="margin: 3px 0 0 0;"
                                id="widget-access-modal-subtitle">
                ...
                <div class="modal-body"
                    ...
                    <div class="widget-access-mode-box">
                        <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 4px;">
                            <i data-lucide="shield"
                                style="width: 16px; height: 16px; color: var(--color-cyan);"></i>
                            <label
                                style="font-size: 0.85rem; font-weight: 700; color: var(--text-primary); margin: 0;"
                    ...
                    <div id="widget-role-selector-container"
                        ...
                        <div
                            ...
                            <div style="display: flex; align-items: center; gap: 8px;">
                                ...
                                <span style="font-size: 0.85rem; font-weight: 700; color: var(--text-primary);"
                                    id="widget-role-selector-title">Pilih Role Yang Diizinkan Melihat Widget
                                    Ini:</span>
                            </div>
                            <div style="display: flex; gap: 8px;">
                                <button type="button" class="btn btn-outline btn-xs"
                                    onclick="selectAllWidgetRoles(true)"
                                    style="padding: 3px 10px; font-size: 0.75rem; border-radius: 6px;">Pilih
                                    Semua</button>
                                <button type="button" class="btn btn-outline btn-xs"
                                    onclick="selectAllWidgetRoles(false)"
                                    style="padding: 3px 10px; font-size: 0.75rem; border-radius: 6px;">Hapus
                                    Semua</button>
                            </div>
                        </div>
                ...
                <div class="modal-footer widget-access-modal-footer">
                    ...
                    <button type="button" class="btn btn-primary glow-button"
                        onclick="saveDashboardWidgetPermission()"
        ...
        <!-- ponytail: App Logic -->
        <script src="/ejo-engineer-assets/app.js?v=37.0"></script>
    </body>
