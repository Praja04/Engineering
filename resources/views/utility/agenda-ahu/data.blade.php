                                ...
                                function renderEditChecklistItem($fieldName, $labelText)
                                {
                                    ...
                                    <div class="edit-item py-2 border-bottom">
                                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                                         ...
                                         </div><input type="text" class="form-control form-control-sm edit-input-description bg-soft-danger text-danger border-danger mt-2" name="keterangan_' . $fieldName . '" id="edit_keterangan_' . $fieldName . '" placeholder="Isi keterangan kerusakan / ketidaksesuaian..." style="display: none;">
                                    </div>
                                    ';
                                }
                            }
