                            ...
                            <div class="col">
                                ...
                                <p class="text-white-50 mb-0 fs-13 mt-1">
                                    @if(auth()->user()->jabatan === 'foreman')
                                        ...
                                        Approve laporan yang telah disubmit operator
                                    @elseif(auth()->user()->jabatan === 'supervisor')
                                        <span class="badge bg-info text-dark me-1">Supervisor</span>
                                        Final approval laporan yang telah disetujui foreman
                                    @endif
                                </p>
                            </div>
                            <div class="col-auto">
        ...
        <div class="row g-3 mt-1">
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body d-flex align-items-center gap-3">
                        <div class="rounded-3 d-flex align-items-center justify-content-center"
                            style="background:#fff3cd;width:52px;height:52px;min-width:52px;">
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm">
                    <div class="card-body d-flex align-items-center gap-3">
                        <div class="rounded-3 d-flex align-items-center justify-content-center"
                            style="background:#d1e7dd;width:52px;height:52px;min-width:52px;">
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm">
                    <div class="card-body d-flex align-items-center gap-3">
                        <div class="rounded-3 d-flex align-items-center justify-content-center"
                            style="background:#cfe2ff;width:52px;height:52px;min-width:52px;">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow">
            <div class="modal-header border-bottom"
                style="background:linear-gradient(135deg,#f6c90e,#f7971e);">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        ...
                        <table class="table table-sm table-bordered mb-0">
                            <tr><th class="text-muted w-50">Air</th><td id="m-air">—</td></tr>
                            <tr><th class="text-muted">Steam</th><td id="m-steam">—</td></tr>
                            <tr><th class="text-muted">Batubara</th><td id="m-batubara">—</td></tr>
                            <tr><th class="text-muted">Efisiensi</th><td id="m-efisiensi">—</td></tr>
                            <tr><th class="text-muted">Pengisian</th><td id="m-pengisian">—</td></tr>
                        </table>
                    </div>
                    <div class="col-md-6">
                        <h6 class="fw-semibold text-muted border-bottom pb-2">Running Hour & Feed Tank</h6>
                        <table class="table table-sm table-bordered mb-0">
                            <tr><th class="text-muted w-50">RH Awal</th><td id="m-rh-awal">—</td></tr>
                            <tr><th class="text-muted">RH Akhir</th><td id="m-rh-akhir">—</td></tr>
                            <tr><th class="text-muted">FT Awal</th><td id="m-ft-awal">—</td></tr>
                            <tr><th class="text-muted">FT Akhir</th><td id="m-ft-akhir">—</td></tr>
                        </table>
                        <h6 class="fw-semibold text-muted border-bottom pb-2 mt-3">Chemical</h6>
                        <table class="table table-sm table-bordered mb-0">
                            <tr><th class="text-muted w-50">SCF</th><td id="m-scf">—</td></tr>
                            <tr><th class="text-muted">SRTF</th><td id="m-srtf">—</td></tr>
                            <tr><th class="text-muted">Dosis</th><td id="m-dosis">—</td></tr>
                        </table>
                    </div>
                </div>
...
$(function () {
    ...
    function loadData() {
        ...
        $.get('{{ route("esp-shift-report.json") }}', { status, tanggal, jabatan }, function (data) {
            // Hitung summary
    ...
    $(document).on('click', '.btn-review', function () {
        ...
        steps.forEach(function (s, i) {
            ...
            chain += `
                <div class="d-flex flex-column align-items-center gap-1 text-center" style="min-width:80px;">
    ...
    function doApprove(id) {
        const url = jabatan === 'foreman'
            ? `/esp/shift/${id}/approve-foreman`
            : `/esp/shift/${id}/approve-supervisor`;
