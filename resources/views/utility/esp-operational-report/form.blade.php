...
<div class="page-content">
    <div class="container-fluid">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                ...
                                <span class="badge fs-12" id="badge-tanggal-shift" style="background:rgba(255,255,255,.15); color:#fff;"></span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="section-pilihan" class="row g-4 mt-1">
            <div class="col-md-6">
                <div class="card border-0 shadow-sm h-100 esp-pick-card" id="btn-pick-operational" style="cursor:pointer; transition:.2s;">
                    <div class="card-body p-4 d-flex flex-column">
                        <div class="d-flex align-items-center mb-3">
                            <div class="rounded-3 d-flex align-items-center justify-content-center me-3" style="background:linear-gradient(135deg,#4361ee,#3a0ca3);
                        ...
                        <div class="border-top pt-2 d-flex justify-content-between align-items-center">
                            <span class="text-muted fs-13"><i class="ri-time-line me-1"></i>Setiap jam (06:00–05:00)</span>
                            <span class="text-primary fw-semibold fs-13">Pilih <i class="ri-arrow-right-line"></i></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card border-0 shadow-sm h-100 esp-pick-card" id="btn-pick-shift" style="cursor:pointer; transition:.2s;">
                    <div class="card-body p-4 d-flex flex-column">
                        <div class="d-flex align-items-center mb-3">
                            <div class="rounded-3 d-flex align-items-center justify-content-center me-3" style="background:linear-gradient(135deg,#f72585,#7209b7);
                                       width:56px;height:56px;min-width:56px;">
                        ...
                        <div class="border-top pt-2 d-flex justify-content-between align-items-center">
                            <span class="text-muted fs-13"><i class="ri-time-line me-1"></i>Akhir shift (sebelum 06:00)</span>
                    ...
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            <form id="form-operational">
                                ...
                                <div class="row g-3">
                                    <div class="col-6">
                                        <label class="form-label fw-medium">Jam Laporan <span class="text-danger">*</span></label>
                                        <select class="form-select" name="jam_laporan" id="jam_laporan" required>
                                            <option value="">-- Pilih Jam --</option>
                                            @php
                                            $hours = [];
                                            for($h=6;$h<=23;$h++) $hours[]=sprintf('%02d:00',$h); for($h=0;$h<=5;$h++) $hours[]=sprintf('%02d:00',$h); @endphp @foreach($hours as $h) <option value="{{ $h }}">{{ $h }}</option>
                                                @endforeach
                                        </select>
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label fw-medium">Grup <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="number" step="0.01" class="form-control" name="arus_primer" placeholder="0.00">
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label fw-medium">Arus Sekunder (mA)</label>
                                        <input type="number" step="0.01" class="form-control" name="arus_sekunder" placeholder="0.00">
                                    </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="number" step="0.01" class="form-control" name="tegangan_primer" placeholder="0.00">
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label fw-medium">Tegangan Sekunder (kV)</label>
                                        <input type="number" step="0.01" class="form-control" name="tegangan_sekunder" placeholder="0.00">
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="number" step="0.01" class="form-control" name="suhu_thermal" placeholder="0.00">
                                    </div>

                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary w-100" id="btn-submit-operational">
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-header bg-transparent border-bottom d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex gap-2">
                                <select class="form-select form-select-sm" id="filter-grup-operational" style="width:auto;">
                        ...
                        <div class="card-header bg-transparent border-bottom">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <span class="badge bg-danger fs-13 px-3 py-2" id="display-tanggal-shift">—</span>
                                    @endif
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <form id="form-shift">
                                ...
                                <div class="mb-3">
                                    ...
                                    @if(auth()->user()->jabatan === 'operator')
                                    <input type="date" class="form-control" name="tanggal_laporan" id="input-tanggal-shift" readonly style="background:#f8f9fa; cursor:not-allowed;">
                                    @else
                                    <input type="date" class="form-control" name="tanggal_laporan" id="input-tanggal-shift">
                                    @endif
                                </div>
                                ...
                                <div id="alert-waktu-shift" class="alert alert-warning d-none" role="alert">
                                    ...
                                    Laporan hanya bisa diinput sebelum jam <strong>06:00</strong>.
...
<script>
    $(function() {
        ...
        $('.esp-pick-card').on('mouseenter', function() {
            $(this).css('transform', 'translateY(-4px)').css('box-shadow', '0 8px 24px rgba(0,0,0,.12)');
        ...
        function loadOperationalPreview() {
            ...
            $.get('{{ route("esp-operational-report.json") }}', {
                ...
                $('#tbody-operational-preview').html(html || '<tr><td colspan="7" class="text-center text-muted py-3">Belum ada data</td></tr>');
            });
        }
        ...
        $('#form-operational').on('submit', function(e) {
            ...
            $.ajax({
                ...
                complete: function() {
                    $btn.prop('disabled', false).html('<i class="ri-save-line me-1"></i>Simpan Data');
                }
            });
        });
            ...
            $.ajax({
                ...
                success: function(res) {
                    Swal.fire({
                        ...
                        text: res.message ?? 'Laporan shift berhasil disubmit dan menunggu approval.',
                ...
                complete: function() {
                    $btn.prop('disabled', false).html('<i class="ri-send-plane-line me-1"></i>Submit Laporan');
                }
            });
        });
