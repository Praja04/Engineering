                ...
                <div class="modal-content border-0 shadow">
                    ...
                    <div class="modal-body p-4">
                        <div class="alert alert-info border-0 shadow-sm mb-4">
                            <i class="mdi mdi-information me-2"></i>Laporan mencakup data <strong>Proses, Performance, Sludge,</strong> dan <strong>Chemical</strong> pada tanggal atau bulan yang dipilih.
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3 d-none" id="input_bulan_container">
                            ...
                            <input type="month" class="form-control form-control-lg" id="export_bulan" value="{{ date('Y-m') }}" max="{{ date('Y-m') }}">
                        </div>
                    </div>
