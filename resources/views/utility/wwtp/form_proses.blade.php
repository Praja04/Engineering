        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="row g-3">
                    <!-- Daily Data Card -->
                    <div class="col-md-6">
                        <div class="card form-selector-card h-100 active" data-bs-toggle="tab" data-bs-target="#dailyForm" role="tab">
                    ...
                    <!-- Weekly Data Card -->
                    <div class="col-md-6">
                        <div class="card form-selector-card h-100" data-bs-toggle="tab" data-bs-target="#weeklyForm" role="tab">
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Icon/Image -->
                                    <div class="mb-3">
                                ...
                                <form id="dailyWwtpForm">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="number" class="form-control" id="daily_debit1" name="debit1" required>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="number" class="form-control" id="daily_debit2" name="debit2" required>
                                            <div class="form-text">Debit air masuk (m³/h)</div>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <select class="form-select" id="daily_running_wwtp1" name="running_wwtp1" required>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <select class="form-select" id="daily_running_wwtp2" name="running_wwtp2" required>
                                                <option value="">-- Pilih Status --</option>
                                                <option value="ON">ON</option>
                                                <option value="OFF">OFF</option>
                                            </select>
                                    ...
                                    <div class="mb-4">
                                        <div class="d-flex align-items-center mb-4">
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="text-muted mb-0">Input volume air masuk dari berbagai sumber</p>
                                            </div>
                                            <div class="flex-shrink-0">
                                                <button type="button" class="btn btn-sm btn-outline-primary" id="calculateDailyTotal">
                                ...
                                <form id="weeklyWwtpForm">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select" id="weekly_kategori" name="kategori" required>
                                    ...
                                    <div id="weekly_influent_form" style="display: none;">
                                        <div class="mb-4">
                                            <div class="d-flex align-items-center mb-4">
                                                ...
                                                <div class="flex-shrink-0">
                                                    <button type="button" class="btn btn-sm btn-outline-primary" id="calculateInfluentTotal">
                                                        <i class="mdi mdi-calculator me-1"></i> Hitung Total
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-4">
                                                    <div class="card border border-primary">
                                                        <div class="card-body">
                                                            <label for="weekly_pit_sparta" class="form-label fw-semibold">
                                                                <i class="mdi mdi-water text-primary me-1"></i>Pit Sparta
                                                            </label>
                                                            <div class="input-group">
                                                                <input type="number" step="0.01" class="form-control" id="weekly_pit_sparta" name="pit_sparta" min="0" placeholder="0.00">
                                                                <span class="input-group-text bg-light">m³</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="card border border-primary">
                                                        <div class="card-body">
                                                            <label for="weekly_pit_garam" class="form-label fw-semibold">
                                                                <i class="mdi mdi-water text-primary me-1"></i>Pit Garam
                                                            </label>
                                                            <div class="input-group">
                                                                <input type="number" step="0.01" class="form-control" id="weekly_pit_garam" name="pit_garam" min="0" placeholder="0.00">
                                                                <span class="input-group-text bg-light">m³</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="card border border-primary">
                                                        <div class="card-body">
                                                            <label for="weekly_pit_domestik" class="form-label fw-semibold">
                                                                <i class="mdi mdi-water text-primary me-1"></i>Pit Domestik
                                                            </label>
                                                            <div class="input-group">
                                                                <input type="number" step="0.01" class="form-control" id="weekly_pit_domestik" name="pit_domestik" min="0" placeholder="0.00">
                                                                <span class="input-group-text bg-light">m³</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="number" step="0.01" class="form-control" id="weekly_pit_produksi_step3" name="pit_produksi_step3" min="0" placeholder="0.00">
                                                                <span class="input-group-text bg-light">m³</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="number" step="0.01" class="form-control" id="weekly_pit_storage" name="pit_storage" min="0" placeholder="0.00">
                                                                <span class="input-group-text bg-light">m³</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="number" step="0.01" class="form-control" id="weekly_pit_proses_wwtp2" name="pit_proses_wwtp2" min="0" placeholder="0.00">
                                                                <span class="input-group-text bg-light">m³</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="number" step="0.01" class="form-control" id="weekly_pit_outlet" name="pit_outlet" min="0" placeholder="0.00">
                                                                <span class="input-group-text bg-light">m³</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="number" step="0.01" class="form-control" id="weekly_pit_boiler" name="pit_boiler" min="0" placeholder="0.00">
                                                                <span class="input-group-text bg-light">m³</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div id="weekly_effluent_form" style="display: none;">
                                        <div class="mb-4">
                                            <div class="d-flex align-items-center mb-4">
                                                ...
                                                <div class="flex-shrink-0">
                                                    <button type="button" class="btn btn-sm btn-outline-success " id="calculateEffluentTotal">
                                                        <i class="mdi mdi-calculator me-1"></i> Hitung Total
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    <div class="card border border-success">
                                                        <div class="card-body">
                                                            <label for="weekly_full_proses" class="form-label fw-semibold">
                                                                <i class="mdi mdi-water-check text-success me-1"></i>Full Proses
                                                            </label>
                                                            <div class="input-group">
                                                                <input type="number" step="0.01" class="form-control" id="weekly_full_proses" name="full_proses" min="0" placeholder="0.00">
                                                                <span class="input-group-text bg-light">m³</span>
                                                            </div>
                                                            <small class="form-text text-muted">Volume air hasil proses lengkap</small>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card border border-success">
                                                        <div class="card-body">
                                                            <label for="weekly_daf_pre" class="form-label fw-semibold">
                                                                <i class="mdi mdi-water-check text-success me-1"></i>DAF Pre
                                                            </label>
                                                            <div class="input-group">
                                                                <input type="number" step="0.01" class="form-control" id="weekly_daf_pre" name="daf_pre" min="0" placeholder="0.00">
                                                                <span class="input-group-text bg-light">m³</span>
                                                            </div>
                                                            <small class="form-text text-muted">Volume air hasil DAF preliminary</small>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    $(document).ready(function() {
        ...
        $('#weekly_kategori').on('change', function() {
            ...
            if (kategori === 'influent') {
                ...
                $('#weekly_pit_sparta, #weekly_pit_garam, #weekly_pit_domestik').prop('required', false);
