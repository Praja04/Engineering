                    ...
                    <form id="pengangkutanForm">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control" id="tanggal_pengangkutan" name="tanggal_pengangkutan" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" step="0.01" class="form-control" id="jumlah_pengangkutan" name="jumlah_pengangkutan" min="0" placeholder="0.00" required>
    ...
    $(document).ready(function() {
        ...
        $('#pengangkutanForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                data: formData,
                success: function(response) {
                    $('#successMessage').html(response.message || 'Data pengangkutan sludge telah berhasil disimpan ke sistem.');
                    $('#successModal').modal('show');
