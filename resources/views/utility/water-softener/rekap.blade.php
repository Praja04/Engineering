    ...
    <div class="container-fluid">
        ...
        <div class="rekap-header" data-aos="fade-down">
            <div class="d-flex align-items-start justify-content-between flex-wrap gap-3">
                ...
                <div class="d-flex gap-2 align-items-center flex-wrap">
                    <a href="{{ route('water-softener.index') }}" class="btn btn-sm btn-outline-light rounded-pill px-3">
                        <i class="bx bx-edit me-1"></i>Input Harian
                    </a>
                    <a href="{{ route('water-softener.approval') }}" class="btn btn-sm btn-outline-light rounded-pill px-3">
        ...
        <div class="filter-card" data-aos="fade-up" data-aos-delay="50">
            <div class="row align-items-end g-3">
                ...
                <div class="col-auto">
                    <button class="btn btn-submit-month px-4" id="btnLoad" style="background:linear-gradient(135deg,#1a6aad,#2c8fe0);">
            ...
            <div class="modal-body p-4">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-sm-3">
                        ...
                        <input type="text" class="form-control fp-time-edit" id="edit_ws1_jam" placeholder="HH:MM" readonly>
                    </div>
                    <div class="col-sm-3">
                        <label class="edit-lbl">Flow (m³/h)</label>
                        <input type="number" step="0.01" min="0" class="form-control" id="edit_ws1_flow">
                    </div>
                    <div class="col-sm-3">
                        <label class="edit-lbl">Hardness In (ppm)</label>
                        <input type="number" step="0.01" min="0" class="form-control" id="edit_ws1_hardness_in">
                    </div>
                    <div class="col-sm-3">
                        <label class="edit-lbl">Hardness Out (ppm)</label>
                        <input type="number" step="0.01" min="0" class="form-control" id="edit_ws1_hardness_out">
                    </div>
                </div>
                ...
                <div class="row g-3 mb-3">
                    <div class="col-sm-3">
                        <label class="edit-lbl">Jam Operasi</label>
                        <input type="text" class="form-control fp-time-edit" id="edit_ws2_jam" placeholder="HH:MM" readonly>
                    </div>
                    <div class="col-sm-3">
                        <label class="edit-lbl">Flow (m³/h)</label>
                        <input type="number" step="0.01" min="0" class="form-control" id="edit_ws2_flow">
                    </div>
                    <div class="col-sm-3">
                        <label class="edit-lbl">Hardness In (ppm)</label>
                        <input type="number" step="0.01" min="0" class="form-control" id="edit_ws2_hardness_in">
                    </div>
                    <div class="col-sm-3">
                        <label class="edit-lbl">Hardness Out (ppm)</label>
                        <input type="number" step="0.01" min="0" class="form-control" id="edit_ws2_hardness_out">
                    </div>
                </div>
                ...
                <div class="row g-3 mb-3">
                    <div class="col-sm-3">
                        ...
                        <input type="text" class="form-control fp-time-edit" id="edit_regen1_jam" placeholder="HH:MM" readonly>
                    </div>
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="number" step="0.01" min="0" class="form-control" id="edit_regen1_air_pelarut">
                    </div>
                    <div class="col-sm-3">
                        <label class="edit-lbl">Garam (kg)</label>
                        <input type="number" step="0.01" min="0" class="form-control" id="edit_regen1_garam">
                    </div>
                </div>
                ...
                <div class="row g-3">
                    <div class="col-sm-3">
                        <label class="edit-lbl">Jam Regen</label>
                        <input type="text" class="form-control fp-time-edit" id="edit_regen2_jam" placeholder="HH:MM" readonly>
                    </div>
                    <div class="col-sm-3">
                        <label class="edit-lbl">Nomer WS</label>
                    ...
                    <div class="col-sm-3">
                        <label class="edit-lbl">Air Pelarut (L)</label>
                        <input type="number" step="0.01" min="0" class="form-control" id="edit_regen2_air_pelarut">
                    </div>
                    <div class="col-sm-3">
                        <label class="edit-lbl">Garam (kg)</label>
                        <input type="number" step="0.01" min="0" class="form-control" id="edit_regen2_garam">
                    </div>
                </div>
...
<script>
    $(function() {
        ...
        function loadData() {
            ...
            $.ajax({
                ...
                error: function() {
                    ...
                    $('#tblBody').html('<tr><td colspan="12" class="text-center text-muted py-4">Gagal memuat data</td></tr>');
                }
            });
        }
        ...
        function buildSummary(rows, approval) {
            ...
            const over = rows.filter(r => parseFloat(r.ws1_hardness_out) > 10 || parseFloat(r.ws2_hardness_out) > 10).length;
        ...
        function buildTable(rows, approval) {
            ...
            if (!rows.length) {
                $body.html('<tr><td colspan="12" class="text-center text-muted py-4">Tidak ada data bulan ini</td></tr>');
                return;
            }
        ...
        $('#btnSaveEdit').on('click', function() {
            ...
            const $btn = $(this).prop('disabled', true).html('<i class="bx bx-loader-alt bx-spin me-1"></i>Menyimpan…');
            ...
            $.ajax({
                ...
                complete: function() {
                    $btn.prop('disabled', false).html('<i class="bx bx-save me-1"></i>Simpan Perubahan');
                }
            });
        });
        ...
        $('#btnSubmitConfirm').on('click', function() {
            ...
            const $btn = $(this).prop('disabled', true).html('<i class="bx bx-loader-alt bx-spin me-1"></i>Mengirim…');
            ...
            $.ajax({
                ...
                complete: function() {
                    $btn.prop('disabled', false).html('<i class="bx bx-send me-1"></i>Ajukan ke Supervisor');
                }
            });
        });
