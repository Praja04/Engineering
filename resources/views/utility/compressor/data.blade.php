    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title text-white"><i class="ri-file-excel-2-line me-1"></i> Export Excel Compressor</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="formExport" action="{{ route('compressor.export') }}" method="GET" target="_blank">
                    <div class="row g-2">
                        <div class="col-md-4">
                    ...
                    <div class="alert alert-info mt-3 mb-0" style="font-size: 0.85rem;">
                        <i class="ri-information-line me-1"></i> Data akan diekspor menggunakan template Excel yang tersedia di sistem.
                    </div>
                </form>
            </div>
            <div class="modal-footer">
...
<script>
    ...
    function showCollectedDetail(index) {
        ...
        $('#modalCollectedDetailTitle').text(`Detail Data Minggu ke-${app.week} (${moment(app.tgl_awal).format('DD MMM')} - ${moment(app.tgl_akhir).format('DD MMM YYYY')})`);
