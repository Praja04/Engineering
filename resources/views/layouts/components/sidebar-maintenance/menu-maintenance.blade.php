...
@if (
    ...
    <li class="nav-item">
        <a class="nav-link menu-link {{ request()->is('mtc/*') ? '' : 'collapsed' }}" href="#sidebarMtc"
            data-bs-toggle="collapse" role="button" aria-expanded="{{ request()->is('mtc/*') ? 'true' : 'false' }}"
            aria-controls="sidebarMtc">
            <i class="mdi mdi-account-wrench"></i> <span data-key="t-mtc">Maintenance</span>
        </a>
        <div class="collapse menu-dropdown {{ request()->is('mtc/*') ? 'show' : '' }}" id="sidebarMtc">
            <ul class="nav nav-sm flex-column">
                <li class="nav-item">
                    ...
                    <a href="#" data-bs-target="#sidebarP2hMtc" data-bs-toggle="collapse" role="button"
                        aria-expanded="{{ request()->is('mtc/p2h/*') ? 'true' : 'false' }}"
                        aria-controls="sidebarP2hMtc" class="nav-link" data-key="t-p2h-mtc">
                        <i class="mdi mdi-car-cog"></i>P2H
                    </a>
                    <div class="collapse menu-dropdown {{ request()->is('mtc/p2h/*') ? 'show' : '' }}"
                        id="sidebarP2hMtc">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('p2h.form.index') }}"
                                    class="nav-link {{ request()->routeIs('p2h.form.index') ? 'active' : '' }}">
                                    <i class="mdi mdi-file-document"></i>Form P2H</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('p2h.data.index') }}"
                                    class="nav-link {{ request()->routeIs('p2h.data.index') ? 'active' : '' }}">
                                    <i class="mdi mdi-file-document"></i>Data P2H</a>
                            </li>
                        </ul>
                    </div>
