...
<li class="nav-item">
    <a class="nav-link menu-link {{ request()->routeIs('master.mtc.*') ? '' : 'collapsed' }}" href="#sidebarMasterMtc" data-bs-toggle="collapse" role="button" aria-expanded="{{ request()->routeIs('master.mtc.*') ? 'true' : 'false' }}" aria-controls="sidebarMasterMtc">
    ...
    <div class="collapse menu-dropdown {{ request()->routeIs('master.mtc.*') ? 'show' : '' }}" id="sidebarMasterMtc">
        <ul class="nav nav-sm flex-column">
            <li class="nav-item">
                <a href="{{ route('master.mtc.mesin.index') }}" class="nav-link {{ request()->routeIs('master.mtc.mesin.index') ? 'active' : '' }}">
