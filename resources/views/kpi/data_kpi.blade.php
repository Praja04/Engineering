            ...
            <div class="card-body">
                ...
                <ul class="nav nav-pills nav-justified mb-3" id="boilerTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="weekly-tab" data-bs-toggle="tab" data-bs-target="#weeklyPane" type="button" role="tab">
                            Mingguan
                        </button>
                    </li>

                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="monthly-tab" data-bs-toggle="tab" data-bs-target="#monthlyPane" type="button" role="tab">
                            Bulanan
                        </button>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="weeklyPane" role="tabpanel">
                        <table class="table table-borderless table-striped table-hover align-middle text-nowrap" id="tableWeekly">
                    ...
                    <div class="tab-pane fade" id="monthlyPane" role="tabpanel">
                        <table class="table table-borderless table-striped table-hover align-middle text-nowrap" id="tableMonthly">
                            <thead class="table-light">
                                <tr>
                                    <th>No</th>
                                    <th>Bulan</th>
            ...
            <form id="formKpi">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" id="finish_goods" class="form-control" step="0.01" min="0" required>
                    </div>
    ...
    $(document).ready(function() {
        ...
        function loadData(periode = 'weekly', extraParams = {}, page = 1) {
            ...
            $.get("{{ route('kpi.get-data') }}", params, function(response) {
                ...
                $.each(response.data, function(i, item) {
                    ...
                    const ListrikPrd = formatNumber(item.listrik_prd || '-');
                    const ListrikBas = formatNumber(item.listrik_bas || '-');
        ...
        $form.on('submit', function(e) {
            ...
            const payload = {
                ...
                listrik_prd: $('#listrik_prd').val(),
                listrik_bas: $('#listrik_bas').val(),
                steam: $('#steam').val(),
        ...
        $(document).on('click', '.btnEdit', function() {
            ...
            $.get("{{ url('kpi/show') }}/" + id, function(res) {
                if (res.success) {
                    ...
                    $('#listrik_prd').val(formatNumber(data.listrik_prd || 0));
                    $('#listrik_bas').val(formatNumber(data.listrik_bas || 0));
