...
class KpiController extends Controller
{
    ...
    public function getKpiListrik(Request $request)
    {
        ...
        /**
         * 2. Ambil data listrik berdasarkan range tanggal
         *    HANYA ambil data yang memiliki usage_kwh (bukan NULL)
         */
        $listrik = PemakaianListrikModel::whereBetween('waktu', [$startDate, $endDate])
        ->whereNotNull('usage') // Hanya ambil yang sudah ada usage_kwh-nya
            ->orderBy('panel_type')
            ->orderBy('waktu')
            ->get();
        ...
        /**
         * 4. Hitung total usage per panel (SUM dari kolom usage)
         */
        $panelUsages = [];
        $panelUsageDetails = [];
