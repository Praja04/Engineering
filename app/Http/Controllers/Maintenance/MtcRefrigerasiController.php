...
class MtcRefrigerasiController extends Controller
{
    ...
    {
        return view('maintenance.form.refrigerasi');
    }

    public function viewData()
    {
        return view('maintenance.data.refrigerasi_data');
    }

    public function store(MtcRefrigerasiRequest $request)
    {
        ...
        // Simpan record
        $inspection = MtcRefrigerasiModel::create($data);
    ...
    {
        $query = MtcRefrigerasiModel::query()
    ...
    public function update(MtcRefrigerasiRequest $request, $id)
    {
        $row = MtcRefrigerasiModel::findOrFail($id);
    ...
    {
        $inspection = MtcRefrigerasiModel::find($id);
