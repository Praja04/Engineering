...
class MtcElectricEngineController extends Controller
{
    ...
    {
        return view('maintenance.form.electric_engine');
    }

    public function viewData()
    {
        return view('maintenance.data.electric_engine_data');
    }

    public function store(MtcElectricEngineRequest $request)
    {
        ...
        // Simpan record
        $inspection = MtcElectricEngineModel::create($data);
    ...
    {
        $query = MtcElectricEngineModel::query()
    ...
    public function update(MtcElectricEngineRequest $request, $id)
    {
        $row = MtcElectricEngineModel::findOrFail($id);
    ...
    {
        $inspection = MtcElectricEngineModel::find($id);
